...
class IbBalanceReceiveController extends Controller
{
    public function __invoke(Request $request)
    {
        try {
            ...
            $result = ExternalFundTransfers::where('receiver_id', $ib_user->id)->where('receiver_wallet_type', 'ib');
            // filter by status
            ...
            $result =  $result->with(['sender' => function ($query) {
