...
namespace App\Http\Controllers\Api\copyTrading;
...
class CopyTradesReportController extends Controller
{
    public function copyTradesReport(Request $request)
    {
        $data = $request->all();
        $mampamm = new CopyApiService('mt5');
        $req_data = [
            'command' => 'GetSlaveCopyTradesDataTable',
            'data' =>  $data
        ];
    ...
    // public function copyActivityReport(Request $request)
    // {
    //     $mampamm = new CopyApiService('mt5');
    //     $request = $request->all();
    ...
    //     $sql = "SELECT * FROM copy_activities WHERE slave = '$trade_account'";
