...
namespace App\Http\Controllers\IB\gcash;
...
class GcashWithdrawController extends Controller
{
    ...
    {
        $this->middleware(AllFunctionService::access('gcash_withdraw', 'ib'));
    ...
    public function index(Request $request)
    {
        ...
        return view('ibs.withdraw.gcash-withdraw', [
    ...
    public function gcash_withdraw(Request $request)
    {
        try {
            ...
            $balance = BalanceSheetService::ib_wallet_balance(auth()->user()->id);
    ...
    public function store_withdraw($request)
    {
        ...
        $create = Withdraw::create([
            ...
            'currency' => 'USD',
            'wallet_type' => 'ib',
            'gcash_account' => $request->gcash_ID,
        ]);
        if ($create) {
