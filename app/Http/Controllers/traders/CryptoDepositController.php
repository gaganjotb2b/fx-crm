...
use App\Mail\CryptoDepositRequest;
...
class CryptoDepositController extends Controller
{
    ...
    public function form_view(Request $request)
    {
        ...
        return view(
            'traders.deposit.crypto-deposit',
            [
    ...
    public function crypto_deposit(Request $request)
    {
        ...
        $softwareSettings = SoftwareSetting::select('crypto_deposit')->first();
        ...
        $create = Deposit::create([
            ...
            'approved_status' => ($softwareSettings?->crypto_deposit == 'auto') ? 'A' : 'P',
        ...
        if ($create) {
            ...
            EmailService::send_email('crypto-deposit-request', [
                ...
                'request_amount'  => $request->usd_amount,
            ]);
            // insert activity-----------------
