...
class SupportControllerForUser extends Controller
{

    public function __construct()
    {
        $this->middleware(AllFunctionService::access('support_ticket', 'trader'));
        $this->middleware(AllFunctionService::access('support', 'trader'));
    }
    public function index(Request $request)
    {
        return view('traders.support.client-ticket');
    }
    ...
    public function send_support_reply(Request $request)
    {
        ...
        if ($request->file('file') != null) {
            $validation_rules = [
                'file' => 'file|mimes:jpeg,png,gif,pdf,jpg|max:2048',
            ];
    ...
    public function create_ticket(Request $request)
    {
        ...
        $validation_rules = [
            ...
            'attch' => 'file|mimes:jpeg,png,gif,pdf,jpg|max:2048',
        ];
        $validator = Validator::make($request->all(), $validation_rules);
        if ($validator->fails()) {
            return Response::json([
