...
class BankDepositRequest extends Mailable
{
    ...
    {
        $template = EmailTemplate::select('name')->where('use_for','bank-deposit-request')->first();
        if ($template) {
            ...
            return $this->view('email.mail-bank-deposit-request');
        }
    }
}
