...
class ChangeMasterPassword extends Mailable
{
    ...
    {
        $template = EmailTemplate::select('name')->where('use_for', 'change-master-password')->first();
        if ($template) {
            ...
            return $this->view('email.mail-change-master-password');
        }
    }
}
