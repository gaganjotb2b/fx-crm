...
class ResendAccountCredential extends Mailable
{
    ...
    {
        $template = EmailTemplate::select('name')->where('use_for', 'resend-account-credentials')->first();
        if ($template) {
            return $this->view('email.' . $template->name)
                ->with([
                    ...
                    'clientPhonePassword' => $this->data['clientPhonePassword'],
                    'clientInvestorPassword' => $this->data['clientInvestorPassword'],
                    'clientMasterPassword' => $this->data['clientMasterPassword'],
            ...
            return $this->view('email.mail-resend-account-credentials')
                ->with([
                    'clientName' => $this->data['clientName'],
                    'clientEmail' => $this->data['clientEmail'],
                    'clientAccountNo' => $this->data['clientAccountNo'],
