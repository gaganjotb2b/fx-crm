...
class IbCommssionVersionTwo
{
    ...
    public static function create_comssion()
    {
        try {
            $log = [];
                        ...
                        if (count($all_parent_ib)) {
                            ...
                            foreach ($all_parent_ib as $key => $parent_ib) {
                                ...
                                if ($ib_commission_structure) {
                                    ...
                                    $log[$parent_ib] = ["COMMISSION_NOTFOUND"];
                                }
                            }
                        } else {
                            $status = "IB_NOTFOUND";
    ...
    public static function get_trades()
    {
        try {
            $trades = DB::connection('alternate')->table('MT4_TRADES')
                ...
                ->whereDate('MT4_TRADES.OPEN_TIME', '>=', '2023-10-06')
    ...
    public function get_mt5_trades()
    {
        try {
            ...
            $trades = DB::connection('alternate')->table($this->prefix . 'mt5_trades')
                ...
                ->whereDate($this->prefix . 'mt5_trades.OPEN_TIME', '>=', '2023-07-1')
                ...
                ->limit(500) // need modify after testing 1 to 100
                ->get();
            return $trades;
        } catch (\Throwable $th) {
            // throw $th;
