...
(function (window, document, $) {
  ...
  $('.layout-name').on('click', function () {
    ...
    $('.datatable-inner').removeClass('dt-inner-table-dark');
    table_color(currentLayout);
...
function table_color(layout) {
  if (layout === 'dark-lalyout') {
    $('.datatable-inner').addClass('dt-inner-table-dark');
    $('.datatable-inner').removeClass('dt-inner-table-light');
  }
  else{
    $('.datatable-inner').removeClass('dt-inner-table-dark');
    $('.datatable-inner').addClass('dt-inner-table-light');
  }
}
