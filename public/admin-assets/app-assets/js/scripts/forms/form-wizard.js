...
$(function () {
  ...
  if (typeof modernWizard2 !== undefined && modernWizard2 !== null) {
    var modernStepper = new Stepper(modernWizard2, {
      linear: false
    });
    $(modernWizard2)
      .find('.btn-next')
