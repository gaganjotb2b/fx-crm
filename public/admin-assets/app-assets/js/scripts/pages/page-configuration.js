// theme setup ajax start
$(document).on("submit", "#theme-setup-form", function (event) {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status == false) {
                toastr['error']('Failed To Update!', 'Theme Setup', {
...
$('#mt4_server_type').on('blur keyup', function () {
    $('#mt4_server_type_error').html('');
});
$('#mt5_server_type').on('blur keyup', function () {
