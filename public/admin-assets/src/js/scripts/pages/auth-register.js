...
$(function () {
  ...
  if (typeof registerMultiStepsWizard !== undefined && registerMultiStepsWizard !== null) {
      ...
      $this.validate({
        ...
        messages: {
          password: {
            ...
            pattern: 'Minimum six characters, at least one uppercase, lowercase letter and special character'
          },
          'confirm-password': {
    ...
    // admin registration trigger form
    $(registerMultiStepsWizard)
      ...
      .each(function () {
        $(this).on('click', function (e) {
          ...
          if (isValid) {
            if ($("#dob").val() != "" && $("#platform").val() == "") {
              var submit_v = $('#account_detail_form').trigger('submit');
              numberedStepper.next();
            }
            if ($("#platform").val() != "" && $("#confirm_password").val() == "") {
              $('#profile_detail_form').trigger('submit');
              numberedStepper.next();
              // numberedStepper.next();
            }
          } else {
      ...
      .on('click', function () {
        ...
        if (isValid) {
          ...
          if ($("#confirm_password").val() != "") {
            $('#confirm_detail_form').trigger('submit');
          }
        }
      });
  }
