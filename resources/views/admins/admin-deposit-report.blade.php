                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom d-flex justfy-content-between">
                                <h4 class="card-title">{{__('admin-deposit-report.deposit-report')}}</h4>
                            ...
                            <div class="card-datatable">
                                <table class="datatables-ajax table table-responsive">
                                    <thead>
                                        <tr>
                                            <th>{{__('admin-deposit-report.full-name')}}</th>
                                            <th>{{__('admin-deposit-report.email')}}</th>
                                            <th>{{__('admin-deposit-report.account')}}</th>
                                            <th>{{__('admin-deposit-report.transaction-type')}}</th>
                                            <th>{{__('admin-deposit-report.invoice')}}</th>
                                            <th>{{__('admin-deposit-report.approved-status')}}</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
