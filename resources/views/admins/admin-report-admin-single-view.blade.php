...
<div class="app-content content page-trader-admin">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Trader Admin</li>
                            </ol>
                        </div>
                    </div>
                </div>
    ...
    <!-- END: Content-->
    <div class="card content-wrapper container-xxl p-0" style="background-color: #f3f2f7;">
    ...
    $(document).on("click", ".btn-external-trans", function () {
        ...
        dt_external_trans = dt_external_trans.fetch_data({
            ...
            $(document).on("click", ".trading-account-tab-fill", function () {
                let trader_id = $(this).data('id');
                var dt_bonus = $(this).closest('tr').find('.trading_account');
                dt_bonus = dt_bonus.fetch_data({
                    url: "/admin/client-management/trader-admin-account/" + trader_id,
                    columns: [
                        { "data": "account_number" },
                        { "data": "platform" },
                        { "data": "leverage" },
            ...
            $(".trading-account-tab-fill").trigger("click")
