        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Create Contest</h2>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group">
                                <div class="border-start-3 border-start-primary p-1 mb-1 bg-light-info">
                                    Select Contest type is it no deposit Contest or Contest for specific deposit or simple deposit Contest.
                                </div>
                                <div class="border-start-3 border-start-primary p-1 mb-1 bg-light-info">
                    ...
                    <section class="modern-horizontal-wizard">
                        <div class="bs-stepper wizard-modern modern-wizard-example">
                            ...
                            <div class="bs-stepper-content">
                                <!-- for trader -->
                                <form id="account-details-modern" action="{{route('admin.create.trader-contest')}}" method="post" class="content" role="tabpanel" aria-labelledby="account-details-modern-trigger" enctype="multipart/form-data">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="row">
                                        <!-- hidden groups -->
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="hidden-groups">Hide Groups</label>
                                            <select name="hidden_groups[]" id="hidden-groups" class="form-select select2" multiple="multiple" placeholder="Select groups to hide contest menu from">
                                                @foreach($groups as $value)
                                                <option value="{{$value->id}}">{{$value->group_id}}</option>
                                                @endforeach
                                            </select>
                                            <small class="text-muted">Select groups whose traders will not see the contest menu in sidebar</small>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <!-- clients -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <select name="contest_type" id="contest-type" class="form-select select2">
                                                ...
                                                <option value="on_equity">Contest on equity</option>
                                            </select>
                                        </div>
                                        <!-- country /is global-->
                                    ...
                                    <div class="mb-1 row create-container">
                                        <div class="col-md-8">
                                            <label>Prize</label>
                                            <div class="row" id="prize-row-trader">
                                                <!-- price  -->
                                                <div class="col-md-6">
                                                    <input class="form-control label mb-1" value="1st price" type="text" name="level[]" />
                                                </div>
                                                <!-- value -->
                                ...
                                <form id="personal-info-modern" action="{{route('admin.create.ib-contest')}}" method="post" enctype="multipart/form-data" class="content" role="tabpanel" aria-labelledby="personal-info-modern-trigger">
                                    ...
                                    <div class="row">
                                        <!-- hidden groups /IB -->
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="hidden-groups-ib">Hide Groups</label>
                                            <select name="hidden_groups[]" id="hidden-groups-ib" class="form-select select2" multiple="multiple" placeholder="Select groups to hide contest menu from">
                                                @foreach($groups as $value)
                                                <option value="{{$value->id}}">{{$value->group_id}}</option>
                                                @endforeach
                                            </select>
