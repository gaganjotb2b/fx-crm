...
@section('title', 'Admin Withdraw Report')
@section('vendor-css')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Admin Withdraw Report</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Admin Withdraw Report
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body mt-2 table-responsive">
                                    ...
                                    <table id="withdraw_tbl" class="datatables-ajax ib-withdraw table">
                                        <thead>
                                            <tr>
...
<script>
    ...
    var dt = $('#withdraw_tbl').DataTable({
        ...
        "ajax": {
            "url": "/admin/finance/withdraw-report-dt?op=data_table",
            "data": function(d) {
    ...
    $(document).on("click", ".dt-description", function(params) {
        ...
        $.ajax({
            type: "GET",
            url: '/admin/finance/withdraw-report-dt/description/' + id,
            dataType: 'json',
