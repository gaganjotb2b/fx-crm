...
<div class="app-content content ">
    ...
    <div class="content-wrapper container-fluid p-0">
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('admin-breadcrumbs.ib_analysis') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('admin-breadcrumbs.ib_analysis') }}
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.ib-analysis-get-data')}}" method="post" id="ib-analysis-form">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4 col-12 mb-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By Name Or Email">
                                <!-- search email/name -->
                                <!-- <input id="search-email" class="form-control" type="text" placeholder="Search by Name or Email" name="search_email" /> -->
                                <select name="search_email" id="ib-email" class="form-select">
                                    <option value="">Choose an IB</option>
                                </select>
                            </div>
                            <div class="col-lg-4 col-12 mb-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Start To End Date">
                            ...
                            <div class="col-lg-4 col-12" data-bs-toggle="tooltip" data-bs-placement="top" title="Filter">
                                <button type="button" class="btn btn-primary mb-1 w-100" id="filter" onclick="_run(this)" data-el="fg" data-form="ib-analysis-form" data-loading="<div class='spinner-border spinner-border-sm' role='status'><span class='visually-hidden'>Loading...</span></div>" data-callback="ib_analysis_call_back" data-btnid="filter">Filter</button>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card bg-light-primary">
                                        <div class="card-body">
                                            ...
                                            <div id="ib-commission-label">IB Commission (Total)</div>
                                        </div>
                                    </div>
                                </div>
                                <!-- total trader -->
                                ...
                                <div class="col-lg-4">
                                    <div class="card bg-light-primary">
                                        <div class="card-body">
                                            <div id="trade-volume-from-ib"><b>N/A</b></div>
                                            <div id="trade-volume-from-ib-label">Trade Volume (From IB)</div>
                                        </div>
                                    </div>
                                </div>
                                <!-- ib commission lot -->
                                <div class="col-lg-4">
                                    <div class="card bg-light-primary">
                                        <div class="card-body">
                                            <div id="ib-commission-lot"><b>N/A</b></div>
                                            <div id="ib-commission-lot-label">IB Commission (Lot)</div>
                                        </div>
                                    </div>
                                </div>
                                <!-- trading accounts -->
                                ...
                                <div class="col-lg-4">
                                    <div class="card bg-light-primary">
                                        <div class="card-body">
                                            <div id="trade-volume-trader"><b>N/A</b></div>
                                            <div id="trade-volume-trader-label">Trade Volume (Trader)</div>
                                        </div>
                                    </div>
                                </div>
                                <!-- total bonus -->
                                <div class="col-lg-4">
                                    <div class="card bg-light-primary">
                                        <div class="card-body">
                                            ...
                                            <div id="total-bonus-label">Total Bonus (Total)</div>
                                        </div>
                                    </div>
                                </div>
                                <!-- total ib -->
...
<script>
    ...
    // filter manager
    // --------------------------------------------------------------
    function ib_analysis_call_back(data) {
        if (data.status == true) {
            ...
            notify('success', data.message, 'IB Analysis')
        } else {
            toastr['warning'](data.message, 'IB Analysis', {
