                                    ...
                                    <div class="bs-stepper-content shadow-none">
                                        ...
                                        <div id="account-details-vertical" class="content live-server-details" role="tabpanel" aria-labelledby="account-details-vertical-trigger">
                                            <div class="row">
                                                ...
                                                ----------------------------------------------------------------------------->
                                                <form action="" method="post" id="first_level_form">
                                                    @csrf
                                                    <!-- Dynamic field start -->
                                                    ...
                                                    @for($i = 1; $i <= $levelNum; $i++) <div class="col-2" id="input_container">
                                                        ...
                                                        <div class="input-group mb-1 touchspin-wrapper w-100 mt-1">
                                                            <input type="text" id="input_field_{{ $i }}" name="input_field_{{$i}}" class="touchspin-color ib-levels p-75" value="0" data-bts-button-down-class="btn btn-primary" data-bts-button-up-class="btn btn-primary" data-bts-decimals="2" data-bts-step="0.01" min="0" />
                                                        </div>
                                                    </div>
                                                    @endfor
                                            </div>
                ...
                <div class="bs-stepper-content shadow-none">
                    ...
                    <div id="account-details-vertical" class="content live-server-details" role="tabpanel" aria-labelledby="account-details-vertical-trigger">
                        <div class="row">
                            ...
                            ----------------------------------------------------------------------------->
                            <form action="" method="post" id="custom_structure_form">
                                @csrf
                                <!-- Dynamic field start -->
                                <div class="card d-flex">
                                    <div class="card-header justify-content-start">
                            ...
                            <div class="row">
                                ...
                                @for ($j = 1; $j <= $levelNum2; $j++) <div class="col-2" id="input_container">
                                    <div class="" id="field_title">Level {{ $j }}</div>
                                        <div class="input-group mb-1 touchspin-wrapper w-100 mt-1">
                                            <input type="text" id="input_field_{{ $j }}" name="input_field_{{ $j }}" class="touchspin-color ib-levels p-75" value="0" data-bts-button-down-class="btn btn-primary" data-bts-button-up-class="btn btn-primary" data-bts-decimals="2" data-bts-step="0.01" min="0" />
                                        </div>
                                    </div>
                                @endfor
                            </div>
