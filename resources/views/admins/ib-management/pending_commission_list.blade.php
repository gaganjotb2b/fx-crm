...
@section('title','Pending Commission List')
@section('vendor-css')
<!-- quill editor  -->
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{__('page.Pending_Commission_List')}}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('page.Pending_Commission_List')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body mt-2">
                                <form id="filter-form" class="dt_adv_search" method="POST">
                                    <div class="row g-1 mb-md-1">
                                        ...
                                        <div class="col-md-4">
                                            <label for="login" class="form-label">Account Number</label>
                                            <input type="text" class="form-control dt-input" data-column="2" name="login" id="login" placeholder="Trading Account Number" data-column-index="2" />
                                        </div>
                                        <!-- Filter By Symbol -->
                                        <div class="col-md-4">
...
<script>
    $(document).ready(function() {
        var master_ib_report = dt_fetch_data(
            '/admin/ib_management/pending_commission_list/fetch-data',
            [{
                    "data": "ticket"
                },
                {
            ...
            true, true, true, [0, 1, 2, 3, 4, 5, 6, 7], null, true, false
        )
    });
</script>
@stop
