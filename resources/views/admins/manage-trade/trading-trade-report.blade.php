...
<style>
    #trade-report-root th:first-child {
        border-left: 3px solid orange;
    }

    #trade-report-root td:first-child {
        border-left: 3px var(--custom-primary) !important;
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{__('admin-menue-left.trading_report')}}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin-menue-left.trading_report')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom d-flex justfy-content-between">
                                ...
                                <div class="btn-exports d-flex justify-content-between">
                                    <div class="count-export badge badge-sm badge-light-success me-1 align-self-center" id="count-export" style="display: none;"> Total <span id="data-write"></span> write</div>
                                    <!-- <select data-placeholder="Export" class="select2-icons form-select" id="fx-export2">
                                    ...
                                    <button type="button" class="btn btn-outline-dropbox" id="export-trade">Export to CSV</button>
                                </div>
                            </div>
                            <!--Search Form -->
                                ...
                                <form class="dt_adv_search" method="POST" id="filter-form">
                                    <div class="row g-1 mb-md-1">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <label for="request-date" class="form-label">{{__('page.trading_date')}}</label>
                                    ...
                                    <div class="row g-1">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="select2 form-select" id="status" name="status">
                                                <option value="">{{__('page.all')}}</option>
                                                <option value="running">{{__('page.open')}}</option>
                                                <option value="closed">{{__('page.closed')}}</option>
                                            </select>
                                        </div>
                                        <!-- <div class="col-md-4">
                                            <div class="row mt-2">
                        ...
                        <div class="card p-2">
                            <div class="card-datatable table-responsive">
                                <table class="datatables-ajax table" id="trade-report-root">
                                    <thead>
                                        <tr>
                                            <th>{{__('page.trade')}}</th>
...
<script src="{{asset('admin-assets/app-assets/js/scripts/tables/trade-report.js')}}"></script>
<script src="{{ asset('admin-assets/app-assets/js/scripts/forms/form-select2.js') }}"></script>
<script src="{{ asset('admin-assets/app-assets/js/scripts/forms/pickers/form-pickers.js') }}"></script>
<script src="https://cdn.jsdelivr.net/npm/xlsx/dist/xlsx.full.min.js"></script>
<script src="{{asset('common-js/rz-plugins/datatable-export.js')}}"></script>

<script>
    $("#count-export").slideUp();
    // Make the initial AJAX request
    $(document).on("click", "#export-trade", function() {
        var form_data = $("#filter-form").serializeObject();
        let file_type = 'csv';
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.offset) {
                    // If there is more data, send the next AJAX request
                    form_data['offset'] = response.offset;
                    $("#count-export").slideDown();
