        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{__('admin-breadcrumbs.ib_fund')}}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{__('admin-breadcrumbs.ib_fund')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card-body mt-2">
                                <form id="filterForm" class="dt_adv_search" method="POST">
                                    <div class="row mb-1 g-1">
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By Status">
                                            <!-- filter by approved status -->
                                            <label for="approved_status" class="form-label">Approved status</label>
                                            <select class="select2 form-select" name="approve_status" id="approve_status">
                                        ...
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By Verification Status">
                                            <!-- filter by kyc status -->
                                            <label for="kyc-status" class="form-label">KYC verification status</label>
                                            <select class="select2 form-select" name="verifi_status" id="verifi_status">
                                                <option value="">{{__('ad-reports.all')}}</option>
                                        ...
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By Verification Status">
                                            ...
                                            <label for="receiver-client-type" class="form-label">Receiver Client Type</label>
                                        ...
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Trader info">
                                    ...
                                    <div class="row mb-1 g-1">
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="IB name / email / phone / country">
                                            <!-- filter by IB info -->
                                        ...
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Sender name / email / phone / country">
                                            <!-- filter by sender name email phone country -->
                                        ...
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Receiver name / email / phone / country">
                                            <!-- filter by receiver name email phone country -->
                                        ...
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By Account Number">
                                    ...
                                    <div class="row g-1 mb-md-1">
                                        <div class="col-md-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Manager name / email / phone">
                                            ...
                                            <input type="text" class="form-control dt-input dt-full-name" data-column="1" name="manager_info" id="manager_info" placeholder="Desk manager / Account manager" data-column-index="0" />
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By Create Date" data-date="2017/01/01" data-date-format="yyyy/mm/dd">
                                                <span class="input-group-text">
...
<script>
    $(document).ready(function() {
        ...
        var dt = $('#fund_transfer_tbl').DataTable({
            ...
            "ajax": {
                ...
                "url": "/admin/report/ib-fund-transfer-report?op=data_table",
                "data": function(d) {
        ...
        $("#resetBtn").click(function() {
            ...
            $('#approve_status').prop('selectedIndex', 0).trigger("change");
            $('#verifi_status').prop('selectedIndex', 0).trigger("change");
            dt.draw();
        });
    ...
    $(document).on("click", ".dt-description", function(params) {
        ...
        $.ajax({
            type: "GET",
            url: '/admin/report/ib-fund-transfer-description/' + user_id,
            dataType: 'json',
