...
@section('title','Balance Upload and Deduction Report')
@section('vendor-css')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">IB Balance Add</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">IB Balance Add
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card-body mt-2">
                                <form class="dt_adv_search" id="filterForm" method="POST">
                                    <div class="row mb-1 g-1">
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Transaction method">
                                            <!-- filter by transaction method -->
                                            <label for="transaction_type" class="form-label">Transaction method</label>
                                        ...
                                        <div class="col-md-3 ">
                                            <!-- filter by kyc verifications status -->
                                        ...
                                        <div class="col-md-3 ">
                                            ...
                                            <select class="select2 form-select" name="created_by" id="created_by">
                                                ...
                                                <option value="system">System (IB | Trader)</option>
                                                <option value="manager">{{__('page.manager')}}</option>
                                    ...
                                    <div class="row g-1 mb-md-1">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" data-bs-toggle="tooltip" data-bs-placement="top" title="IB Info" class="form-control dt-input" data-column="2" name="ib_info" id="ib_info" placeholder="IB Name / Email / Phone / Country" data-column-index="1" />
                                        </div>
                                        <div class="col-md-4">
                                            <label for="manager_info" class="form-label">Manager Info</label>
                                            <input type="text" data-bs-toggle="tooltip" data-bs-placement="top" title="Manager Info" class="form-control dt-input dt-full-name" data-column="1" name="manager_info" id="manager_info" placeholder="Manager Name / Email / Phone" data-column-index="0" />
                                        </div>
                                        <div class="col-md-4">
                                            <label for="trading_acc" class="form-label">Trading Account</label>
                                            <input type="text" data-bs-toggle="tooltip" data-bs-placement="top" title="Trading Account" class="form-control dt-input dt-full-name" data-column="1" name="trading_acc" id="trading_acc" placeholder="Trading Account Number" data-column-index="0" />
                                        </div>
                                        <div class="col-md-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Amount">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group" data-bs-toggle="tooltip" data-bs-placement="top" title="Create Date" data-date="2017/01/01" data-date-format="yyyy/mm/dd">
                                                <span class="input-group-text">
                                ...
                                <table id="deposit_tbl" class="datatables-ajax ib-withdraw table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('ad-reports.Transaction') }} {{ __('ad-reports.method') }}</th>
                                            <th>Created By</th>
...
<script>
    ...
    var dt = $('#deposit_tbl').DataTable({
        ...
        "ajax": {
            "url": "/admin/report/ib-balance-add-report/datatable",
            "data": function(d) {
    ...
    $(document).on("click", ".dt-description", function(params) {
        ...
        $.ajax({
            type: "GET",
            url: '/admin/report/ib-balance-add-report/dt-descriptions/' + id,
            dataType: 'json',
