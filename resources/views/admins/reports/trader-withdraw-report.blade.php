...
@section('title', 'Trader Withdraw Report')
@section('vendor-css')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Trader Withdraw</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Trader Withdraw</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body mt-2">
                                <form class="dt_adv_search" id="filterForm" method="POST">
                                    <div class="row g-1 mb-1">
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Transaction Method Filter">
                                            <!-- filter by transaction method -->
                                            <label for="" class="form-label">Transaction Method</label>
                                            <select class="select2 form-select withdraw-method" id="transaction_type" name="transaction_type" id="select2-basic">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <label for="kyc-status">KYC Verification Status</label>
                                            <select class="select2 form-select" name="verify_status" id="kyc-status">
                                        ...
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Approved status">
                                            <!-- filter by approved status -->
                                            <label for="" class="form-label">Approve Status</label>
                                        ...
                                        <div class="col-md-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Created by">
                                    ...
                                    <div class="row g-1 mb-md-1">
                                        <div class="col-md-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By Trader Information">
                                            <!-- filter by trader info -->
                                            <label for="trader-info" class="form-label">Trader Info</label>
                                            <input id="trader_info" type="text" class="form-control dt-input dt-full-name" data-column="1" name="trader_info" placeholder="Trader Name / Email / Phone / Country" data-column-index="0" />
                                        </div>
                                        <div class="col-md-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By IB Information">
                                            <!-- filter by ib info -->
                                            <label for="ib-info" class="form-label">IB Info</label>
                                            <input id="ib_info" type="text" class="form-control dt-input dt-full-name" data-column="1" name="ib_info" placeholder="IB Name / Email / Phone / Country" data-column-index="0" />
                                        </div>
                                        ...
                                        <div class="col-md-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By Trading Account">
                                            ...
                                            <input id="trading_account" type="text" class="form-control dt-input dt-full-name" data-column="1" name="trading_account" placeholder="Trading Account Number" data-column-index="0" />
                                        </div>
                                        <!-- filter by manager info -->
                                        <div class="col-md-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By Account / Desk Manager">
                                            <label for="manager-info" class="form-label">Manager Info</label>
                                            <input id="manager_info" type="text" class="form-control dt-input" data-column="2" name="manager_info" placeholder="Account Manager / Desk Manager" data-column-index="1" />
                                        </div>
                                        <!-- filter by amount min / max -->
                                        <div class="col-md-4" data-bs-toggle="tooltip" data-bs-placement="top" title="Search By MIN MAX Amount">
                                    ...
                                    <div class="row g-1">
                                        ...
                                        <div class="col-md-4 text-right">
                                            ...
                                            <button id="filterBtn" type="button" class="btn btn-primary form-control" data-column="4" data-column-index="3">{{ __('client-management.Filter') }}</button>
                                        </div>
                                ...
                                <table id="deposit_tbl" class="datatables-ajax ib-withdraw table table-responsive">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="small-none"></th>
                                            <th class="small-none"></th>
                                            <th colspan="2" style="text-align: right;" class="details-control" rowspan="1">{{ __('page.total') }} {{ __('page.amount') }} : </th>
...
<script>
    ...
    var dt = $('#deposit_tbl').DataTable({
        ...
        "ajax": {
            "url": "/admin/report/withdraw/trader/dt",
            "data": function(d) {
    ...
    $(document).on("click", ".dt-description", function(params) {
        ...
        $.ajax({
            type: "GET",
            url: `/admin/report/withdraw-description/${withdrawId}`,
            dataType: 'json',
    ...
    $(document).ready(function() {
        $("#btn_reset").click(function() {
            $("#filterForm")[0].reset();
            $('#kyc-status').prop('selectedIndex', 0).trigger("change");
