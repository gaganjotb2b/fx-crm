        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Create Reward</h2>
                    ...
                    <section class="modern-horizontal-wizard">
                        <div class="bs-stepper wizard-modern modern-wizard-example">
                            ...
                            <div class="bs-stepper-content">
                                <!-- for trader -->
                                <form id="account-details-modern" action="{{route('admin.reward.save')}}" method="post" class="content" role="tabpanel" aria-labelledby="account-details-modern-trigger" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="title-wrapper d-flex">
                                                <div class="d-flex flex-column float-start">
                                                    <div class="form-check form-switch form-check-primary">
                                                        <input type="checkbox" class=" password_settings form-check-input" id="is_admin" name="is_admin" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mb-1 col-md-3" id="search_client">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="hidden" name="client_groups" id="selected-groups-input" value="">
                                    ...
                                    <input type="hidden" name="dependencies" id="stored-data" value="">
                                    <!-- editor -->
    ...
    function updateStoredData() {
        ...
        $(".dynamic-row").each(function () {
            ...
            if (optionValue && inputValue) {
                storedData.push({ option: optionValue, value: inputValue });
            }
        });
