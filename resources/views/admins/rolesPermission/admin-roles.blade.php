            ...
            <div class="content-body">
                ...
                <div class="row position-relative">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="row p-2">
                                <div class="col-lg-5 col-sm-5 d-lg-block d-md-none d-sm-block">
                                    <div class="h-100">
                                        <img src="{{ asset('admin-assets/app-assets/images/illustration/faq-illustrations.svg') }}" class="img-fluid" alt="Image" width="85" />
                                    </div>
                                </div>
                                <div class="col-lg-7 col-md-12 col-sm-7 text-sm-end">
                                        <a href="javascript:void(0)" data-bs-target="#offcanvas-new-role" data-bs-toggle="offcanvas" aria-controls="offcanvasBackdrop" class="stretched-link add-new-role">
                            ...
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Click Action to assign permission">{{ __('admin-management.Actions') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered modal-add-new-role" style="max-width: 1058px;">
                        <div class="modal-content">
                            ...
                            <div class="modal-body px-5 pb-5">
                                ...
                                <form class="row" action="{{ route('admin.set-all-roles-permissions') }}"
                                    id="form-asign-role-perimission" method="post">
                                    @csrf
                                    <div class="col-12">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas-new-role" aria-labelledby="offcanvasLabel">
        ...
        @if (Auth::user()->hasDirectPermission('create admin right management'))
            <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                ...
                <form onkeydown="return event.key != 'Enter';" action="{{ route('admin.add-new-right') }}"
                    method="post" class="role-form p-1" id="add-role-from">
                    @csrf
                    <div class="mb-1">
                    ...
                    <button type="button" class="btn btn-primary mb-1 d-grid w-100 mt-1" id="save-role"
                        onclick="_run(this)" data-el="fg" data-form="add-role-from"
                        data-loading="<div class='spinner-border spinner-border-sm' role='status'><span class='visually-hidden'>Loading...</span></div>"
                        data-callback="add_right_call_back" data-btnid="save-role">Save Right</button>
                    <button type="button" id="btn-close-ofcanvas" class="btn btn-outline-secondary d-grid w-100"
                ...
                <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                    ...
                    <form onkeydown="return event.key != 'Enter';" action="{{ route('admin.update-admin-group') }}"
                        ...
                        <button type="button" class="btn btn-primary mb-1 d-grid w-100 mt-1" id="save-update-group"
                            ...
                            data-loading="<div class='spinner-border spinner-border-sm' role='status'><span class='visually-hidden'>Loading...</span></div>"
                            data-callback="update_group_call_back" data-btnid="save-update-group">Save Change</button>
...
@section('page-js')
    ...
    <script src="{{ asset('admin-assets/app-assets/js/scripts/pages/admin-roles.js') }}"></script>
