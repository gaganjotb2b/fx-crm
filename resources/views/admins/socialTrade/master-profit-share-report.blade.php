...
@section('title','Master Profit Share')
@section('vendor-css')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{__('Master Profit Share')}}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{__('ib-management.Home')}}</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">{{__('Social Trades')}}</a>
                                </li>
                                <li class="breadcrumb-item active">{{__('Master Profit Share')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body mt-2">
                                ...
                                <table id="bonus_report_tbl" class="datatables-ajax table table-responsive">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="7" style="text-align: right;" class="details-control" rowspan="1">{{__('page.total')}} {{__('page.amount')}} : </th>
    ...
    $(document).ready(function() {
        ...
        var dt = $('#bonus_report_tbl').DataTable({
            ...
            "ajax": {
                ...
                "url": "/admin/pamm/master-profit-share-report?op=data_table",
                "data": function(d) {
