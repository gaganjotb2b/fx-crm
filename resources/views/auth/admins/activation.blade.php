    ...
    <div class="row">
        <div class="col-8 mx-auto my-auto text-center">
            ...
            <div class="ptext">
                ...
                You Have Registered On {{ config('app.name') }} Successfully Please Check Your E-Mail For Your Account
                Details.
            </div>
            <br><br>
            <div class="progress">
            ...
            <a href="{{ route('ib.login') }}" class="btn btn-primary py-4" style="width: 200px;">Login Now</a>
            @php
