...
<head>
    ...
    <title id="minutes">{{ strtoupper(config('app.name')) }} - IB Login </title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <p class="text-lead text-white">
                            Start Trading with {{ strtoupper(config('app.name')) }}. Trade and invest in Trading
                ...
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center">
                                <a href="{{ route('ib.registration') }}" class="btn bg-gradient-dark w-100 mt-2 mb-4">{{__('page.sign_up')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
