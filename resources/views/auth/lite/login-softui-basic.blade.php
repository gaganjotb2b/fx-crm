...
<head>
    ...
    <title>
        {{ strtoupper(config('app.name')) }} - Trader Login
    </title>
    <!-- Fonts and icons -->
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="{{ route('trader.login.action') }}" method="POST" enctype="multipart/form-data" role="form" class="text-start login-form-body" id="trader-login-form">
                                ...
                                <div class="text-center">
                                    <a href="{{ route('trader.registration') }}" class="text-light font-weight-bold"><button type="button" class="btn bg-gradient-warning w-100 mt-2 mb-4">Sign up</button></a>
                                </div>
                            </form>
                            <!-- mail verification -->
                            <form action="{{ route('trader.login.action') }}" method="POST" enctype="multipart/form-data" role="form" class="text-start mail-verification-form-body d-none" id="trader-login-mail-verification-form">
                                ...
                                <div class="text-center">
                                    ...
                                    <span class="text-muted text-sm send_verification_key">Haven't received it?<a href="#"> Resend a new code</a>.</span>
                                </div>
                            </form>
                            <!-- google verification -->
