...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">A request to crypto withdraw was received from your {{config('app.name')}} Account</div>
                        ...
                        <tr>
                            <td class="sm-py-32 sm-px-24" style="mso-line-height-rule: exactly; padding: 48px; text-align: center; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                <a href="#" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                                    <img src="{{ get_admin_logo() }}" width="155" alt="{{config('app.name')}} Admin" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0;">
                                </a>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                A request to Crypto withdraw was received from your
                                            ...
                                            <table style="border:1px solid #eceff1; width:100% !important; border-collapse: collapse;">
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border: 1px solid #eceff1; padding:8px">Crypto Address</th>
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$cryptoAddress}}</td>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border:1px solid #eceff1; padding:8px">Crypto Currency</th>
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$currency}}</td>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border:1px solid #eceff1; padding:8px">Blockchain</th>
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$blockchain}}</td>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border:1px solid #eceff1; padding:8px">Amount</th>
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$amount}}</td>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border:1px solid #eceff1; padding:8px">Crypto Amount</th>
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$cryptoAmount}}</td>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border:1px solid #eceff1; padding:8px">Status</th>
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$status}}</td>
                                                </tr>
                                            </table>
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0;">
                                                If you did not intend to crypto withdraw or need our help keeping the account, please
                                                contact us at
                                                <a href="{{$support_email}}" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: var(--custom-primary); text-decoration: none;">{{$support_email}}</a>
                                            </p>
                                            <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                    ...
                                    <tr>
                                        <td style="mso-line-height-rule: exactly; padding-left: 48px; padding-right: 48px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; color: #eceff1;">
                                            <p align="center" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 16px; cursor: default;">
                                                ...
                                                &bull;
                                                <a href="https://www.instagram.com/pixinvents" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img src="{{asset('/admin-assets/app-assets/images/icons/social/instagram.png')}}" width="17" alt="Instagram" style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0; margin-right: 12px;"></a>
                                            </p>
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238;">
                                                Use of our service and website is subject to our
                                                <a href="#" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: var(--custom-primary); text-decoration: none;">Terms of Use</a> and
                                                <a href="#" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: var(--custom-primary); text-decoration: none;">Privacy Policy</a>.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
