...
<head>
  ...
  <![endif]-->
    <title>Update the security settings</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">A request to update the security settings was received from your {{get_company_name()}} Account</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                A request to update the security settings received from your
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">Your google 2step authentication successfully {{$status}} .</p>
                                            <table style="border-collapse: collapse; margin-bottom:10px; width:100%; text-align:center">
                                                ...
                                                <tr style="border: 1px solid; padding:8px;">
                                                    <td style="border: 1px solid; padding:8px;">Google 2step</td>
                                                    <td style="border: 1px solid; padding:8px;">{{$status }}</td>
                                                </tr>
                                            </table>
