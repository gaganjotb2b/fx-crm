...
<head>
    ...
    <![endif]-->
    <title>KYC Request Approved</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">A request to approve KYC was received from your {{config('app.name')}} Account</div>
