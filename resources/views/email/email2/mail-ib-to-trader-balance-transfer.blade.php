...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">This is an balance
        description for your recent wallet to other trader transfer.</div>
                    ...
                    <table class="sm-w-full" style="width: 600px;" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                            <td class="sm-py-32 sm-px-24"
                                ...
                                <a href="{{$website}}"
                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                                    <img src="{{get_email_logo()}}" width="155" alt="{{config('app.name')}}"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Thanks for using {{config('app.name')}}. This is an balance description
                                                for your recent wallet to other <strong
                                                    style="color: coral;">({{$reciever_name}})</strong> trader transfer.
                                            </p>
                                            <table style="width: 100%;" cellpadding="0" cellspacing="0"
                                                role="presentation">
                                                <tr>
                                                    <td
                                                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; padding: 16px; font-size: 16px;">
                                                        <table style="width: 100%;" cellpadding="0" cellspacing="0"
                                                            role="presentation">
                                                            <tr>
                                                                <td
                                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; font-size: 16px;">
                                                                    <strong>Amount previous:</strong>
                                                                    ${{$previous_balance}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td
                                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; font-size: 16px;">
                                                                    <strong>Transfer to:</strong> {{$reciever_email}}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                            ...
                                            <table style="width: 100%;" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td
                                                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                                                        <h3
                                                            style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-top: 0; text-align: left; font-size: 14px; font-weight: 700;">
                                                            Transfer Date: </h3>
                                                    </td>
                                                    <td
                                                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                                                        <h3
                                                            style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-top: 0; text-align: right; font-size: 14px; font-weight: 700;">
                                                            {{$transfer_date}}
                                                        </h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2"
                                                        ...
                                                        <table style="width: 100%;" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td
                                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; width: 80%; padding-top: 10px; padding-bottom: 10px; font-size: 16px;">
                                                                    Previous Balance
                                                                </td>
                                                                <td align="right"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right"
                                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; width: 20%; text-align: right; font-size: 16px;">
                                                                    &dollar;{{$transfer_amount}}</td>
                                                            </tr>
                                                            <tr>
                                                                <td
                                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; width: 80%;">
                                                                    <p align="right"
                                                                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; padding-right: 16px; text-align: right; font-size: 16px; font-weight: 700; line-height: 24px;">
                                                                        Current Wallet Balance
                                                                    </p>
                                                                </td>
                                                                <td
                                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; width: 20%;">
                                                                    <p align="right"
                                                                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; text-align: right; font-size: 16px; font-weight: 700; line-height: 24px;">
                                                                        ${{$total_balance}}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                            ...
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-top: 6px; margin-bottom: 20px; font-size: 16px; line-height: 24px;">
                                                If you have any questions about this transaction, please contact us at
                                                <a href="mailto:{{$emailSupport}}" class="hover-underline"
                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #7367f0; text-decoration: none;">
                                                    {{$emailSupport}} </a> or reach out to our
                                                <a href="{{$website}}"
                                                    style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">support
                                                    team</a> for help.
                                            </p>
                                            <p
                                                style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-top: 6px; margin-bottom: 20px; font-size: 16px; line-height: 24px;">
                                                Cheers,
                                                <br>The {{get_company_name()}} Team
                                            </p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <p align="center"
                                    ...
                                    <a href="{{get_company_social_link('facebook')}}"
                                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img
                                            src="{{asset('admin-assets/app-assets/images/icons/social/facebook.png')}}"
                                    ...
                                    <a href="{{get_company_social_link('twitter')}}"
                                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img
                                            src="{{asset('admin-assets/app-assets/images/icons/social/twitter.png')}}"
                                            width="17" alt="Twitter"
                                            style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0; margin-right: 12px;"></a>
                                    &bull;
                                    <a href="{{get_company_social_link('skype')}}"
                                        style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: #263238; text-decoration: none;"><img
                                            src="{{asset('admin-assets/app-assets/images/icons/social/skype.png')}}"
                                            width="17" alt="Skype"
                                            style="max-width: 100%; vertical-align: middle; line-height: 100%; border: 0; margin-right: 12px;"></a>
                                </p>
                                <p
                                    ...
                                    <a href="{{$website}}" class="hover-underline"
