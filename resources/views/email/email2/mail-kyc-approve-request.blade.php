                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            <table style="text-align:left; margin: 0 auto 0; font-size:15px;  line-height: 22px; font-family:'Roboto' , arial; font-weight:400; border-collapse: collapse; width:100%">
                                                <tbody>
                                                    <tr>
                                                        <th style="text-align:center;border:solid 1px #cbcbb8;color:#263238;padding:15px">Document Type :</th>
                                                        <td style="text-align:center;border:solid 1px #cbcbb8;padding:15px"> {{ $document_name }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th style="text-align:center;border:solid 1px #cbcbb8;color:#263238;padding:15px">Status :</th>
                                                        <td style="text-align:center;border:solid 1px #cbcbb8;padding:15px">{{ $status }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
