<html>
   <head>
      ...
      <style type="text/css">*, ::after, ::before{ box-sizing: border-box;}
         ...
         .mail-header-bottom{
            background-image: url(@yield('class-img'));
         }
      </style>
   </head>
   <body>
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td style="padding: 0px 0px;">
                                          @yield('image')
                                          {{-- <a href="#" style="display: inherit;"><img alt="" src="{{asset('mail-assets/mail-header.jpeg')}}" style="
                                          width: 100%; display: inherit;"></a> --}}
                                       </td>
                                    </tr>
                        ...
                        <tr>
                           <td style="background-color: #F39561; padding: 0px 30px 30px;">
                              <table border="0" cellpadding="0" cellspacing="0" style="border-spacing: 0pt;" width="100%">
                                 <tbody>
                                    <tr>
                                       <td style="background-color: #ffffff; border-left: 1px solid#F39561; border-right: 1px solid #F39561; padding: 0px 42px">
                                          <table border="0" cellpadding="0" cellspacing="0" style=
                                             "border-spacing: 0pt;" width="100%">
                                             <tbody>
                                                <tr>
                                                    <td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; line-height: 24px; color: #062652; padding-top: 20px;">
                                                      ...
                                                      @yield('content')
                                                      {{-- <p>Someone has created a Core Prime Ltd account with this email address. If this was you, click the link below to verify your email address
                                                      </p>
                                                      <p>
                                          ...
                                          <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-spacing: 0pt;">
                                             <tbody>
                                                <tr>
                                                   ...
                                                   <td style="padding: 0px 5px;"><a href="" style="display: inherit;" target="_blank">
													<img alt="instagram" src="{{asset('mail-assets/icon-instagram.png')}}" style="display: inherit;"></a>
                                       </td>
