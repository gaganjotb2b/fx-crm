...
<head>
  ...
  <![endif]-->
    <title>Your Trading account created</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">We are please to welcome you to {{get_company_name()}}</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                A request to create trading account was received from your
                                                ...
                                                ({{$name}}) . From the IP - <span style="font-weight: 600;">{{request()->ip()}}</span> .
                                            </p>
                                            ...
                                            <table style="border-collapse:collapse;margin-top:8px; width:100%;">
                                                <tr style="border: 1px solid #eceff1; padding:8px; background: aliceblue;">
                                                    <th style="border: 1px solid #eceff1; padding:8px;">User Name</th>
                                                </tr>
                                                <tr style="border: 1px solid #eceff1; padding:8px;">
                                                    <td style="border: 1px solid #eceff1; padding:8px;">{{$user_email}}</td>
                                                </tr>
                                            </table>
                                            <table style="border-collapse:collapse;margin-top:8px; width:100%;">
                                                <tr style="border: 1px solid #eceff1; padding:8px; background: aliceblue;">
                                                    <th style="border: 1px solid #eceff1; padding:8px;">Login Password</th>
                                                </tr>
                                                <tr style="border: 1px solid #eceff1; padding:8px;">
                                                    <td style="border: 1px solid #eceff1; padding:8px;">{{$clientPassword }}</td>
                                                </tr>
                                            </table>
                                            <table style="border-collapse:collapse;margin-top:8px; width:100%;">
                                                <tr style="border: 1px solid #eceff1; padding:8px; background: aliceblue;">
                                                    <th style="border: 1px solid #eceff1; padding:8px;">Transaciton pin</th>
                                                </tr>
                                                <tr style="border: 1px solid #eceff1; padding:8px;">
                                                    <td style="border: 1px solid #eceff1; padding:8px;">{{$clientTransactionPassword}}</td>
                                                </tr>
                                            </table>
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 0;">If you have not already deposited funds into your trading account, you can Login now to fund your account using one of the available payment methods. </p>
                                            <table style="border-collapse:collapse;margin-top:8px; width:100%;">
                                                <tr style="border: 1px solid #eceff1; padding:8px; background: aliceblue;">
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 0;">If you have not already deposited funds into your trading account, you can Login now to fund your account using one of the available payment methods. </p>
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin-bottom: 0; font-size: 18px; font-weight: 500;">How can you use {{get_company_name()}} for your expected earning?</p>
                                            ...
                                            <table cellpadding="0" cellspacing="0" role="presentation">
                                                <tr>
                                                    <td style="mso-line-height-rule: exactly; mso-padding-alt: 16px 24px; border-radius: 4px; background-color: #7367f0; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                                        <a href="{{$loginUrl}}" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: block; padding-left: 24px; padding-right: 24px; padding-top: 16px; padding-bottom: 16px; font-size: 16px; font-weight: 600; line-height: 100%; color: #ffffff; text-decoration: none;">Login &rarr;</a>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">Thanks, <br>The {{get_company_name()}} Team</p>
                                        </td>
                                    </tr>
                                    <tr>
