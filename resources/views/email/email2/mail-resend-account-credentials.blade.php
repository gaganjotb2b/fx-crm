...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">A request to find account info was received from your {{config('app.name')}} Account</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                A request to find account info was received from your
                                                ...
                                                IP - <span style="font-weight: 600;">{{request()->ip()}}</span>.
                                                @else
                                                Admin - <span style="font-weight: 600;">{{$admin}}</span>.
                                                @endif
                                            </p>
                                            ...
                                            <table style="border:1px solid #eceff1; width:100% !important; border-collapse: collapse;">
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border:1px solid #eceff1; padding:8px">Password</th>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$new_password}}</td>
                                                </tr>
                                            </table>
                                            <table style="border:1px solid #eceff1; width:100% !important; border-collapse: collapse; margin-top: 10px;">
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border: 1px solid #eceff1; padding:8px">Account Number</th>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$account_number}}</td>
                                                </tr>
                                            </table>
                                            <table style="border:1px solid #eceff1; width:100% !important; border-collapse: collapse; margin-top: 10px;">
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border:1px solid #eceff1; padding:8px">Master Password</th>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$master_password}}</td>
                                                </tr>
                                            </table>
                                            <table style="border:1px solid #eceff1; width:100% !important; border-collapse: collapse; margin-top: 10px;">
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border:1px solid #eceff1; padding:8px">Investor Password</th>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$investor_password}}</td>
                                                </tr>
                                            </table>
                                            <table style="border:1px solid #eceff1; width:100% !important; border-collapse: collapse; margin-top: 10px;">
                                                <tr style="border:1px solid #eceff1">
                                                    <th style="border:1px solid #eceff1; padding:8px">Phone Password</th>
                                                </tr>
                                                <tr style="border:1px solid #eceff1">
                                                    <td style="border:1px solid #eceff1; padding:8px">{{$phone_password}}</td>
                                                </tr>
                                            </table>
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0;">
                                                If you did not intend to reset transaction pin or need our help keeping the account, please
                                                contact us at
