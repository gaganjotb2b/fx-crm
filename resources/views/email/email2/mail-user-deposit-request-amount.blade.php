...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Deposit amount update by an admin from your {{config('app.name')}} Account</div>
  <div role="article" aria-roledescription="email" aria-label="Update deposit amount" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
