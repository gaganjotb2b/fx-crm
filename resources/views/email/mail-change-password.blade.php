...
<head>
  ...
  <![endif]-->
    <title>Chnage login password</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">A request change login password was received from your {{get_company_name()}} Account</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                A request to change login password received from your
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">Your new Login Credential .</p>
                                            <table style="border-collapse: collapse; margin-bottom:10px; width:100%; text-align:center">
                                                <tr style="border: 1px solid #626262; padding:8px;">
                                                    <th style="border: 1px solid #626262; padding:8px;">User name</th>
                                                    <th style="border: 1px solid #626262; padding:8px;">Password</th>
                                                </tr>
                                                <tr style="border: 1px solid #626262; padding:8px;">
                                                    <td style="border: 1px solid #626262; padding:8px;">{{$account_email}}</td>
                                                    <td style="border: 1px solid #626262; padding:8px;">{{$clientPassword}}</td>
                                                </tr>
                                            </table>
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0;">
                                                If you did not intend to change password or need our help keeping the account, please
                                                contact us at
