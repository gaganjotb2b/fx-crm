...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">A request to reset transaction pin was received from your {{config('app.name')}} Account</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 24px;">
                                                A request to change transaction pin was received from your
                                                ...
                                                ({{$name}}) from the Admin - <span style="font-weight: 600;">{{$admin}}</span> .
                                            </p>
                                            ...
                                            <table style="border:1px solid; border-collapse: collapse; width: 100%;">
                                                <tr style="border:1px solid; padding: 8px;">
                                                    <th style="border: 1px solid; padding: 8px;">User Name</th>
                                                    <td style="border:1px solid; padding: 8px;">{{$account_email}}</td>
                                                </tr>
                                                <tr style="border:1px solid; padding: 8px;">
                                                    <th style="border:1px solid; padding: 8px;">New Transaction Pin</th>
                                                    <td style="border:1px solid; padding: 8px;">{{$transaction_pin}}</td>
                                                </tr>
                                            </table>
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0;">
                                                If you did not intend to change transaction pin or need our help keeping the account, please
                                                contact us at
