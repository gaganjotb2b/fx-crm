...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
    <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">A approve KYC request was received from your {{config('app.name')}} Account</div>
                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">Now your account is verified</p>
                                            <table style="text-align:left; margin: 0 auto 0; font-size:15px;  line-height: 22px; font-family:'Roboto' , arial; font-weight:400; color: #d9daf1;">
                                                <tbody>
                                                    <tr>
                                                        <td style="text-align:center;border:solid 1px #cbcbb8;color:#263238;padding:15px">Document Type :</td>
                                                        <td style="text-align:center;border:solid 1px #cbcbb8;color:#5a1515;padding:15px"> {{ $document_name }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="text-align:center;border:solid 1px #cbcbb8;color:#263238;padding:15px">Status :</td>
                                            ...
                                            <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0;">
                                                If you did not intend to approved request or need our help to KYC verification, please
                                                contact us at
                                                <a href="{{$support_email}}" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: green; text-decoration: none;">{{ $support_email }}</a>
                                            </p>
