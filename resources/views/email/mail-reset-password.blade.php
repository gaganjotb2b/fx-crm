                                                    ...
                                                    <td style="mso-line-height-rule: exactly; mso-padding-alt: 16px 24px; border-radius: 4px;  font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                                        <table style="border:1px solid #eceff1;">
                                                            <tr style="border:1px solid #eceff1">
                                                                <th style="border: 1px solid #eceff1">User Name</th>
                                                                <td style="border:1px solid #eceff1">{{$account_email}}</td>
                                                            </tr>
                                                            <tr style="border:1px solid #eceff1">
                                                                <th style="border:1px solid #eceff1">Password</th>
                                                                <td style="border:1px solid #eceff1">{{$new_password}}</td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
