...
<head>
  ...
  <![endif]-->
  <title>Deposit amount update</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">Your deposit amount update by an admin from your {{config('app.name')}} Account</div>
  <div role="article" aria-roledescription="email" aria-label="Deposit amount update" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                ...
                <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                      ...
                      <p class="sm-leading-32" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px; font-size: 24px; font-weight: 600; color: #263238;">
                        Your Deposit Amount updated by Admin!
                      </p>
                      <h2 style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">Your current deposit:$ {{ $amount }}</h2>
                      
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0;">
                        If you did not know why this amount updated or need our help keeping the account, please
                        contact us at
                        <a href="mailto:{{ get_support_email() }}" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: var(--custom-primary); text-decoration: none;">{{ $support_email }}</a>
                      </p>
                      <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                        <tr>
                      ...
                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px;">Thanks</p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="mso-line-height-rule: exactly; padding-left: 48px; padding-right: 48px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; color: #eceff1;">
                      ...
                      <!--  <a href="https://pixinvent.com/" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: var(--custom-primary); text-decoration: none;">Terms of Use</a> and-->
                      <!--  <a href="https://pixinvent.com/" class="hover-underline" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; color: var(--custom-primary); text-decoration: none;">Privacy Policy</a>.-->
                      <!--</p>-->
                    </td>
                  </tr>
                  <tr>
