...
<head>
  ...
  <![endif]-->
  <title>Update withdraw amount</title>
...
<body style="margin: 0; width: 100%; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #eceff1;">
  <div style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: none;">An admin update your withdraw amount from your {{config('app.name')}} Account</div>
  <div role="article" aria-roledescription="email" aria-label="Withdraw amount updated" lang="en" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">
                  ...
                  <tr>
                    <td class="sm-px-24" style="mso-line-height-rule: exactly; border-radius: 4px; background-color: #ffffff; padding: 48px; text-align: left; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 16px; line-height: 24px; color: #626262;">
                      ...
                      <p class="sm-leading-32" style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-bottom: 16px; font-size: 24px; font-weight: 600; color: #263238;">
                        Your Withdraw Amount updated by Admin!
                      </p>
                      <h2 style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly;">Your current withdraw:$ {{ $amount }}</h2>

                      <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0;">
                        If you did not intend to approved request or need our help keeping the account, please
                        contact us at
