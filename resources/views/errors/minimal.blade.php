        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="index.html">
                        <img class="img img-fluid" src="{{ get_admin_logo() }}" alt="{{ config('app.name') }}" style="max-width:100px">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <a class="btn btn-primary mb-1 btn-sm-block" href="{{ url()->previous() }}">Back to Home</a><img class="img-fluid" src="{{asset('admin-assets/app-assets/images/pages/not-authorized.svg')}}" alt="Not authorized page" />
                        </div>
                    </div>
                </div>
                <!-- / Not authorized-->
