<!DOCTYPE html>
<html class="loading {{ get_admin_theme() }}" lang="en" data-layout="dark-layout" data-textdirection="ltr">
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/app-assets/css/pages/page-misc.css')}}">
    <!-- END: Page CSS-->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="index.html">
                        <img class="img img-fluid" src="{{ get_user_logo() }}" alt="{{ config('app.name') }}" style="width: 200px;">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-2">
                                ...
                                serves.
                            </p><a class="btn btn-primary mb-1 btn-sm-block" href="{{ url()->previous() }}">Back to Previous</a><img class="img-fluid" src="{{asset('admin-assets/app-assets/images/pages/not-authorized-dark.svg')}}" alt="Not authorized page" />
                        </div>
                    </div>
                </div>
                <!-- / Not authorized-->
