        ...
        <div class="col-lg-12">
            <div class="card ">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="p-4 border-bottom border-0 export-button-con">
                ...
                <div class="card-body">
                    <form id="filterForm" class="dt_adv_search" method="POST">
                        <div class="row g-2">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="account_number" class="form-control" id="accountNumber" placeholder="Trading Account Number">
                                </div>
                            </div>
                            <!-- filter by platform -->
                            <div class="col-lg-4 col-md-6 mb-3">
                                <select class="form-select" name="deposit_method" id="platform">
                                    <option value="" disabled selected> All Deposit Method</option>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table datatables-ajax w-100" id="datatable_withdraw">
                            <thead>
...
<script>
    const deposit_report = $("#datatable_withdraw").DataTable({
        "processing": true,
        "serverSide": true,
        "searching": false,
        "lengthChange": true,
        ...
        "dom": 'B<"clear">lfrtip',
        ajax: {
            url: "{{ url('ib/affiliates/clients-deposit-report') }}?action=table",
            data: function(d) {
                return $.extend({}, d, {
                    "status": $("#status").val(),
                    "fiGroup": $("#fiGroup").val(),
