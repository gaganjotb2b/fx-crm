...
$pending_withdraw = BalanceService::get_ib_pending_withdraw(auth()->user()->id);
@endphp
    ...
    <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">{{ __('page.total-client-deposit') }}</span>
                                                <span class="widget-stats-amount">$ {{ $client_deposit_balance }}</span>
                                                <span class="widget-stats-info"></span></br>
                                            </div>
                                ...
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">{{ __('page.total-trader') }}</span>
                                                <span class="widget-stats-amount">{{ $total_trader }}</span>
                                                <span class="widget-stats-info">{{ $total_sub_ib }}  {{ __('page.sub-ib') }}</span>
                                            </div>
                                ...
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">{{ __('page.todays-earning') }}</span>
                                                <span class="widget-stats-amount">$ {{ $todays_ib_erning }}</span>
                                                <span class="widget-stats-info"> $ {{ $total_commission }} {{ __('page.total-commission') }}</span>
                                            </div>
                                            <!-- <div class="widget-stats-indicator widget-stats-indicator-positive align-self-start">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="card widget widget-payment-request">
                                            <div class="card-header">
                                                <h5 class="card-title">IB PROFILE<span class="badge badge-warning badge-style-light">{{ date_format(auth()->user()->created_at, "d M Y") }}</span></h5>
                                            ...
                                            <div class="card-body">
                                                <div class="widget-payment-request-container">
                                                    ...
                                                    <div class="widget-payment-request-actions m-t-lg d-flex">
                                                        <a href="{{ route('ib.ib-admin-account-settings') }}" class="btn btn-light flex-grow-1 m-r-xxs">Edit Profile</a>
                                                        <a href="{{ route('ib.ib-admin-account-verification') }}" class="btn btn-primary flex-grow-1 m-l-xxs">Verify Account</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 ms-auto">
                                        <div class="card" >
                                            <div class="card-body text-center p-3" style="height: 285px;">
