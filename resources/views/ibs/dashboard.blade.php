...
@section('content')
                        ...
                        <div class="card-body p-3 trd-referal">
                            <div class="input-group mb-3 referale-link-2">
                                ...
                                <input type="text" class="form-control" id="trader-referral-link" placeholder="https://"
                                    aria-label="https://" aria-describedby="button-addon2" value="{{ $trader_referral }}">
                        ...
                        <div class="card-body">
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                ...
                                <span class="alert-text">
                                    ...
                                    <a href="{{ route('ib.ib-admin-account-verification') }}"
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <h1 class="text-gradient text-primary"><span id="status1"
                                        countto="21">{{ $total_commission }}</span> <span
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <h1 class="text-gradient text-primary"> <span id="status2"
                                        countto="{{ $total_trader }}">{{ $total_trader }}</span> <span
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <h1 class="text-gradient text-primary"><span id="status4"
                                        countto="{{ $total_sub_ib }}">{{ $total_sub_ib }}</span> <span
                ...
                <div class="row mt-4">
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                <h1 class="text-gradient text-primary"><span id="status3"
                                        countto="87">{{ $client_deposit_balance }}</span> <span
                                        class="text-lg ms-n2"></span></h1>
                    ...
                    <div class="col-md-6 mt-md-0 mt-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <h1 class="text-gradient text-primary"><span id="status3"
                                        countto="87">{{ $client_withdraw_balance }}</span> <span
                                        class="text-lg ms-n2"></span></h1>
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body text-center">
                                <h1 class="text-gradient text-primary"><span id="status3"
                                        countto="87">{{ $todays_ib_erning }}</span> <span class="text-lg ms-n2"></span>
                                </h1>
                    ...
                    <div class="col-md-6 mt-md-0 mt-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <h1 class="text-gradient text-primary"><span id="status4"
                                        countto="{{ $yesterday_ib_erning }}">{{ $yesterday_ib_erning }}</span> <span
                                        class="text-lg ms-n2"></span></h1>
                        ...
                        <div class="row">
                            <div class="col-5 text-center">
                                ...
                                <h4 class="font-weight-bold mt-n8">
                                    <span>{{ $apx_lot }}</span>
                                    <span class="d-block text-body text-sm">{{ __('page.apx-lots') }}</span>
                                </h4>
                            </div>
                            <div class="col-7">
    ...
    <!--        <input type="hidden" id="popup-visibility" value="{{ $popup_visibility }}">-->
