...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">IB Banner</li>
    </ol>
                        ...
                        <table class="banner-report table table-flush datatables-ajax w-100" id="banner-report">
                            <!-- <div class="nav-wrapper position-relative end-0 pt-3 col-12">
                                <ul class="nav nav-pills nav-fill p-1 trans-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link mb-0 px-0 py-1 banner-user active" data-user="ib" data-bs-toggle="tab" href="#" role="tab" aria-selected="true">
                                            IB Banner
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link mb-0 px-0 py-1 banner-user" data-user="trader" data-bs-toggle="tab" href="#" role="tab" aria-selected="false">
                                            Trader Banner
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <!-- <div class="btn-group">
                                <span class="btn btn-outline-primary pe-none">IB Banner</span>
                                <span class="btn btn-outline-primary"></span>
                                <span class="btn btn-outline-primary pe-none">Trader Banner</span>
                            </div> -->
...
<script>
    ...
    // let eng_banner = $("#marketing_eng_banner").fetch_data({
    //     url: "/ib/marketing/banner/?op=banner_table",
    //     columns: [{
    //             "data": "banner"
    //         },
    //         {
...
<!-- <script>
    ...
    //     return d.extra;
    // }
    // $(document).on('click', '.banner-user', function() {
    //     let banner_user = $(this).data('user');
    //     // Initialize the DataTable instance only if it has not been initialized yet
    //     if (dt === null) {
    //         dt = $('.banner-report').DataTable({
    //             language: {
    //                 search: "",
    //                 lengthMenu: " _MENU_ ",
    //                 paginate: {
    ...
    //             serverSide: true,
    //             ajax: {
    //                 url: "/ib/marketing/banner/table-description/" + banner_user,
    //                 data: function(d) {
    //                     return $.extend({}, d, {});
    //                 },
    //             },
    ...
    //         });
    //     } else {
    //         // Update the DataTable options based on the user's interaction
    //         dt.ajax.url('/ib/marketing/banner/table-description/' + banner_user).load();
    //         dt.order([1, 'desc']).draw();
    //     }
    //     // Clear the detailRows array when the DataTable is initialized or updated
    //     detailRows = [];
...
<script>
    ...
    var dt = $('.banner-report').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "/ib/marketing/banner/table-description/ib",
            "data": function(d) {
                return $.extend({}, d, {});
            }
        },
