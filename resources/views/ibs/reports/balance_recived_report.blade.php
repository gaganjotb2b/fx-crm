                        ...
                        <form id="filter-form" class="dt_adv_search" method="POST">
                            <div class="row g-2">
                                <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="" data-bs-original-title="Search By Sender Info">
                                    <div class="">
                                        <!-- filter by sender email / name -->
                                        <input type="text" name="sender_info" class="form-control" id="sender-info"
                                ...
                                <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <select class="form-select" name="transaction_type" id="transaction-type">
                                        ...
                                        <option value="trader_to_ib">Trader to IB</option>
                                    </select>
                                </div>
                                <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
...
@section('page-js')
    ...
    <script>
        const balanceTransferDT = $("#balance_send_datatable").fetch_data({
            url: "/ib/reports/ib-balance/recived?action=table",
            columns: [{
