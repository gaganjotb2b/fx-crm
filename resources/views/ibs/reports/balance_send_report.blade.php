...
@section('title', 'Balance Send Report')
@section('page-css')
                        ...
                        <form id="filter-form" class="dt_adv_search" method="POST">
                            <div class="row g-2">
                                <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="" data-bs-original-title="Search By Receiver Info">
                                    <div class="">
                                        <!-- filter by receiver email / name -->
                                        <input type="text" name="receiver_info" class="form-control" id="receiver-info"
                                            placeholder="Receiver name / email">
                                    </div>
                                </div>

                                <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="" data-bs-original-title="Search By Status">
                                ...
                                <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="" data-bs-original-title="Search by transaction type">
                                    <!-- filter by transaction type -->
                                    <select class="form-select" name="transaction_type" id="transaction-type">
                                        <option value="">{{ __('page.all') }}</option>
                                        <option value="ib_to_ib">IB to IB</option>
                                        <option value="ib_to_trader">IB to Trader</option>
                                    </select>
                                </div>
                                <div class="col-lg-4 col-md-6  mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="" data-bs-original-title="Search By Amount">
                                    <div class="col-12">
                                ...
                                <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="" data-bs-original-title="Search By Date">
                                    <div class="col-12">
                                        <div class="col-12 input-rang-group">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-flush datatables-ajax w-100" id="balance_send_datatable">
...
@section('page-js')
    ...
    <script>
        const balanceTransferDT = $("#balance_send_datatable").fetch_data({
            url: "/ib/reports/ib-balance/send?action=table",
            columns: [{
