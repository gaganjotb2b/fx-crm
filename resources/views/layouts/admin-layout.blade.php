            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="dropdown-menu-footer">
                            <a class="btn btn-primary w-100"
                                href="{{ route('admin.system-notification.view-all') }}?type=client">View All Client</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="dropdown-menu-footer">
                            <a class="btn btn-success w-100"
                                href="{{ route('admin.system-notification.view-all') }}?type=deposit">View All Deposits</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="dropdown-menu-footer">
                            <a class="btn btn-warning w-100"
                                href="{{ route('admin.system-notification.view-all') }}?type=withdraw">View All Withdrawals</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="dropdown-menu-footer">
                            <a class="btn btn-info w-100"
                                href="{{ route('admin.system-notification.view-all') }}?type=transfer">View All Transfers</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="dropdown-menu-footer">
                            <a class="btn btn-secondary w-100"
                                href="{{ route('admin.system-notification.view-all') }}?type=account">View All Account</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="dropdown-menu-footer">
                            <a class="btn btn-purple w-100"
                                href="{{ route('admin.combine-ib-request') }}">View All IB Requests</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown dropdown-notification me-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="dropdown-menu-footer">
                            <a class="btn btn-info w-100" href="{{ route('admin.manage_banks.bank_account_list') }}">View All Bank Accounts</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="dropdown-menu-footer">
                            <a class="btn btn-danger w-100"
                                href="{{ route('admin.system-notification.view-all') }}?type=system">View All System</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#"
                        ...
                        <span class="avatar">
                            <img class="round bg-gradient-primary" src="{{ asset(avatar()) }}" alt="avatar"
                                height="40" width="40">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="{{ Request::is('admin/dashboard') ? 'active' : '' }}" id="mainMenuLi">
                    <a class="d-flex align-items-center" href="{{ route('admin.dashboard') }}">
                        ...
                        <span class="menu-item text-truncate"
                            data-i18n="Configuration">{{ __('page.dashboard') }}</span>
                    </a>
                </li>
                        ...
                        <li class=" nav-item">
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="Admin-Profile">{{ __('page.admin_profile') }}</span>
                            ...
                            <ul class="menu-content">
                                    ...
                                    @role('change profile')
                                        <li class="{{ Request::is('admin/profile/*') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.profile-settings') }}"><i
                                ...
                                @if (PermissionService::has_permission('notification', 'admin'))
                                    @role('notification')
                                        <li
                                            class="{{ Request::is('admin/allNotification/allNotification*') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.allNotification.allNotification') }}">
                                                <i data-feather="bell"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="eCommerce">{{ __('page.notifications') }} &nbsp;
                    ...
                    @role('manage client')
                        <li class=" nav-item {{ Request::is('admin/client-management/*') ? 'open' : '' }}">
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="Manage Client">{{ __('admin-menue-left.client_management') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- trader admin -->
                                    ...
                                    @role('trader admin')
                                        <li class="{{ Request::is('admin/client-management/trader-admin') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.trader-admin') }}">
                                                ...
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Basic">{{ __('admin-menue-left.trader_admin') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('trader_admin', 'admin'))
                                    @role('trader admin')
                                        <li class="{{ Request::is('admin/client-management/lead-admin') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.lead-admin') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                ...
                                @if (PermissionService::has_permission('trader_analysis', 'admin'))
                                    @role('trader analysis')
                                        <li
                                            class="{{ Request::is('admin/client-management/trader-analysis') ? 'active' : '' }}">
                                ...
                                @if (PermissionService::has_permission('trader_analysis', 'admin'))
                                    @role('trader analysis')
                                        <li
                                        class="{{ Request::is('admin/client-management/special-customer') ? 'active' : '' }}">
                                        <a class="d-flex align-items-center" href="{{ route('admin.trader-special-customer') }}">
                                            <i data-feather="circle"></i>
                                     ...
                                     <!-- assign group -->
                                <li class="{{ Request::is('admin/client-management/assign-group') ? 'active' : '' }}">
                                    <a class="d-flex align-items-center" href="{{ route('admin.assign-group') }}">
                                        <i data-feather="circle"></i>
                                        <span class="menu-item text-truncate" data-i18n="Basic">Assign Group</span>
                                    </a>
                                </li>
                                <li class="{{ Request::is('admin/client-management/manager-groups') ? 'active' : '' }}">
                                    <a class="d-flex align-items-center" href="{{ route('admin.client-management.manager-groups') }}">
                                        <i data-feather="circle"></i>
                    ...
                    @role('ib management')
                        <li class=" nav-item {{ Request::is('admin/ib-management/*') ? 'open' : '' }}">
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="IB Management">{{ __('admin-menue-left.ib_management') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- ib setup -->
                                    ...
                                    @role('ib setup')
                                        <li class="{{ Request::is('admin/ib-management/ib-setup') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.ib-setup-view') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Setup">{{ __('admin-menue-left.ib_setup') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('ib_commission_structure', 'admin'))
                                    @role('ib commission structure')
                                        <li
                                            class="{{ Request::is('admin/ib-management/ib-commission-structure') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.ib-commission-structure') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Commission Structure">{{ __('admin-menue-left.ib_commission_structure') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('ib tree')
                                        <li class="{{ Request::is('admin/ib-management/ib-tree') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.ib-tree') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Tree">{{ __('admin-menue-left.ib_tree') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('pending_commission_list', 'admin'))
                                    @role('panding commission list')
                                        <li
                                            class="{{ Request::is('admin/ib_management/pending_commission_list') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                ...
                                @if (PermissionService::has_permission('no_commission_list', 'admin'))
                                    @role('no commission list')
                                        <li
                                            class="{{ Request::is('admin/ib_management/no_commission_list') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                ...
                                @if (PermissionService::has_permission('ib_chain', 'admin'))
                                    @role('ib-chain')
                                        <li class="{{ Request::is('admin/ib-management/ib-chain') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.ib_management.ib_chain') }}">
                                                <i data-feather="circle"></i>
                                    ...
                                    @role('ib admin')
                                        <li class="{{ Request::is('admin/ib-management/ib-admin-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('ib.admin.report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Admin">{{ __('admin-menue-left.ib_admin') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('ib_verification_request', 'admin'))
                                    @role('ib verification request')
                                        <li
                                            class="{{ Request::is('admin/ib-management/ib-verification-request') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.verification.request-report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Verification Request">{{ __('admin-menue-left.ib_verification_request') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('ib analysis')
                                        <li class="{{ Request::is('admin/ib-management/ib-analysis') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.ib-analysis') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Verification Analysis">{{ __('admin-menue-left.ib_analysis') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                <!-- ib request for combine -->
                                        ...
                                        <li class="{{ Request::is('admin/ib-management/ib-request') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.combine-ib-request') }}">
                                                <i data-feather="circle"></i>
                    ...
                    @role('manage request')
                        <li class=" nav-item {{ Request::is('admin/manage-report/*') ? 'open' : '' }} ">
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="Request Management">{{ __('admin-menue-left.request_management') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- deposit request -->
                                    ...
                                    @role('deposit request')
                                        <li class="{{ Request::is('admin/manage-report/deposit-request') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.manage.deposit') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Deposit Request">{{ __('admin-menue-left.deposit_request') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('withdraw_request', 'admin'))
                                    @role('withdraw request')
                                        <li
                                            class="{{ Request::is('admin/manage-report/withdraw-request') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.manage.withdraw') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Withdraw Request">{{ __('admin-menue-left.withdraw_request') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('account_request', 'admin'))
                                    @role('account request')
                                        <li class="{{ Request::is('admin/manage-report/account-request') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.account-request') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Withdraw Request">{{ __('admin-menue-left.account_request') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('balance_transfer_request', 'admin'))
                                    @role('balance transfer')
                                        <li
                                            class="{{ Request::is('admin/manage-report/balance-transfer') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.balance-transfer') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Balance Transfer">{{ __('admin-menue-left.balance_transfer') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('ib transfer')
                                        <li class="{{ Request::is('admin/manage-report/ib-transfer') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.ib-transfer') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Transfer">{{ __('admin-menue-left.ib_transfer') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('ib_withdraw_request', 'admin'))
                                    @role('ib withdraw request')
                                        <li
                                            class="{{ Request::is('admin/manage-report/ib-withdraw-request') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.ib-transfer.withdraw') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Withdraw Request">{{ __('admin-menue-left.ib_withdraw_request') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                    ...
                    @role('reports')
                        <li class="check_height nav-item {{ Request::is('admin/report/*') ? 'open' : '' }}">
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="Reports">{{ __('admin-menue-left.reports') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- ib withdraw -->
                                @if (PermissionService::has_permission('ib_withdraw', 'admin'))
                                    @role('ib withdraw')
                                        <li class="{{ Request::is('admin/report/withdraw/ib') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ url('admin/report/withdraw/ib') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Withdraw">{{ __('admin-menue-left.ib_withdraw') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('ib_commission', 'admin'))
                                    <li class="{{ Request::is('admin/report/ib-commission') ? 'active' : '' }}">
                                        <a class="d-flex align-items-center"
                                            href="{{ url('admin/report/ib-commission') }}">
                                            <i data-feather="circle"></i>
                                            <span class="menu-item text-truncate"
                                                data-i18n="IB Commission">{{ __('admin-menue-left.ib_commission') }}</span>
                                        </a>
                                    </li>
                                @endif
                                <!-- trader withdraw -->
                                @if (PermissionService::has_permission('trader_withdraw', 'admin'))
                                    @role('trader withdraw')
                                        <li class="{{ Request::is('admin/report/withdraw/trader') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ url('admin/report/withdraw/trader') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Trader Withdraw">{{ __('admin-menue-left.trader_withdraw') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                <!-- block user -->
                                @if (PermissionService::has_permission('blocked_users', 'admin'))
                                    @role('blocked user')
                                        <li class="{{ Request::is('admin/report/blocked_user') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ url('admin/report/blocked_user') }}">
                                                <i data-feather="circle"></i>
                                    ...
                                    @role('activity log')
                                        <li class="{{ Request::is('admin/report/activity-log') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.activity-log') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Activity log">{{ __('admin-menue-left.activity_log') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('bonus_report', 'admin'))
                                    @role('bonus report')
                                        <li class="{{ Request::is('admin/report/user-bonus-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.user.bonus-report') }}">
                                                <i data-feather="circle"></i>
                                ...
                                @if (PermissionService::has_permission('ib_fund_transfer', 'admin'))
                                    @role('ib fund transfer')
                                        <li
                                            class="{{ Request::is('admin/report/ib-fund-transfer-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.user.ib-fund-transfer') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="IB Fund Transfer">{{ __('admin-menue-left.ib_fund_transfer') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('external_fund_transfer', 'admin'))
                                    @role('external fund transfer')
                                        <li class="{{ Request::is('admin/report/external-fund-transfer') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.external-fund-transfer-report') }}">
                                                <i data-feather="circle"></i>
                                ...
                                @if (PermissionService::has_permission('balance_upload_and_deduction', 'admin'))
                                    @role('balance upload report')
                                        <li class="{{ Request::is('admin/report/ib-balance-add-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('ib.balance.report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                    ...
                                    @role('ledger report')
                                        <li class="{{ Request::is('admin/report/ledger-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.report.ledger') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Ledger Report">{{ __('admin-menue-left.ledger_report') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('individual_ledger_report', 'admin'))
                                    @role('individual ledger report')
                                        <li
                                            class="{{ Request::is('admin/report/individual-ledger-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.report.ledger-individual') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="individual Ledger Report">{{ __('admin-menue-left.individual_ledger_report') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                    ...
                    @role('manage admin')
                        <li class=" nav-item {{ Request::is('admin/admin-management/*') ? 'open' : '' }}">
                            <a class="d-flex align-items-center" href="#">
                                <i data-feather="users"></i>
                                <span class="menu-title text-truncate"
                                    data-i18n="Admin Management">{{ __('admin-menue-left.admin_management') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- admin group -->
                                    ...
                                    @role('admin groups')
                                        <li class="{{ Request::is('admin/admin-management/admin-groups') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.admin-groups') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Admin Groups">{{ __('admin-menue-left.admin_groups') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('admin_registration', 'admin'))
                                    @role('admin registration')
                                        <li
                                            class="{{ Request::is('admin/admin-management/admin-registration') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.admin-registration') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Admin Registration">{{ __('admin-menue-left.admin_registration') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('admin right management')
                                        <li class="{{ Request::is('admin/admin-management/roles') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.roles') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Admin Right Management">{{ __('admin-menue-left.admin_right') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                    ...
                    @role('manager settings')
                        <li class=" nav-item {{ Request::is('admin/manager-settings/*') ? 'open' : '' }}">
                            <a class="d-flex align-items-center" href="#">
                                <i data-feather="users"></i>
                                <span class="menu-title text-truncate"
                                    data-i18n="Manager Settings">{{ __('admin-menue-left.manager_settings') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- manager groups -->
                                @if (PermissionService::has_permission('manager_groups', 'admin'))
                                    @role('manager groups')
                                        <li
                                            class="{{ Request::is('admin/manager-settings/manager-group') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.manager-groups') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Manager Groups">{{ __('admin-menue-left.manager_groups') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('add manager')
                                        <li class="{{ Request::is('admin/manager-settings/add-manager') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.add-manager') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Add Manager">{{ __('admin-menue-left.add_manager') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('manager list')
                                        <li class="{{ Request::is('admin/manager-settings/get-manager') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.get-manager') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Manager List">{{ __('admin-menue-left.manager_list') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('manager_right', 'admin'))
                                    @role('manager right')
                                        <li
                                            class="{{ Request::is('admin/manager-settings/manager-right') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.all-manager-with-right') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Manager Right">{{ __('admin-menue-left.manager_right') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('manager_analysis', 'admin'))
                                    @role('manager analysis')
                                        <li
                                            class="{{ Request::is('admin/manager-settings/manager-analysis') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.manager-analysis-view') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Manager Analysis">{{ __('admin-menue-left.manager_analysis') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                <!-- manage all -->
                                @if (PermissionService::has_permission('manager_settings', 'admin'))
                                    @role('manage all')  {{-- Yeh line change ki hai --}}
                                        <li class="{{ Request::is('admin/manager-settings/manage-all') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.manage-all') }}">
                                                <i data-feather="circle"></i>
                    ...
                    @role('finance')
                        <li class=" nav-item {{ Request::is('admin/finance/*') ? 'open' : '' }}">
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="Finance">{{ __('admin-menue-left.finance') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- balance management -->
                                @if (PermissionService::has_permission('balance_management', 'admin'))
                                    @role('balance management')
                                        <li class="{{ Request::is('admin/finance/balance-management') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.finance-balance') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Balance Management">{{ __('admin-menue-left.balance_management') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('credit management')
                                        <li class="{{ Request::is('admin/finance/credit-management') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.finance-credit') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Credit Management">{{ __('admin-menue-left.credit_management') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('fund_management', 'admin'))
                                    @role('fund management')
                                        <li class="{{ Request::is('admin/finance/fund-management') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.finance-fund-management') }}">
                                ...
                                @if (PermissionService::has_permission('admin_deposit', 'admin'))
                                    <li class="{{ Request::is('admin/finance/deposit-report') ? 'active' : '' }}">
                                ...
                                @if (PermissionService::has_permission('admin_withdraw', 'admin'))
                                    @role('admin withdraw')
                                        <li class="{{ Request::is('admin/finance/withdraw-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.withdraw-report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate" data-i18n="Finance Reports">Admin
                                                    Withdraw</span>
                                            </a>
                    ...
                    @role('fund transfer')
                        <li class="check_height nav-item {{ Request::is('admin/fund/*') ? 'open' : '' }} ">
                            <a class="d-flex align-items-center" id="height_check" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="Fund Transfer">{{ __('admin-menue-left.fund_trasfer') }}</span>
                            </a>
                            <ul class="menu-content">
                                    ...
                                    @role('internal fund transfer')
                                        <li class="{{ Request::is('admin/fund/internal-fund-transfer') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.fund-report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Internal Fund Transfer">{{ __('admin-menue-left.internal_transfer') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('external_fund_transfer', 'admin'))
                                    @role('external fund transfer')
                                        <li class="{{ Request::is('admin/fund/external-fund-transfer') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.external-fund-report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="External Fund Transfer">{{ __('admin-menue-left.external_transfer') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                ...
                @if (PermissionService::has_permission('group_settings', 'admin'))
                    @role('group settings')
                        <li class="check_height nav-item"><a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="Group Settings">{{ __('admin-menue-left.group_settins') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- group manager -->
                                @if (PermissionService::has_permission('group_manager', 'admin'))
                                    @role('group manager')
                                        <li class="{{ Request::is('admin/client-groups/create') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ url('admin/client-groups/create') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Group Manager">{{ __('admin-menue-left.group_manager') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('group list')
                                        <li class="{{ Request::is('admin/client-groups') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ url('admin/client-groups') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Group List">{{ __('admin-menue-left.group_list') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('manage ib group')
                                        <li class="{{ Request::is('admin/ib-groups') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ url('admin/ib-groups') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Manage IB Group">{{ __('admin-menue-left.manage_ib_group') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                    ...
                    @role('kyc management')
                        <li class=" nav-item {{ Request::is('admin/kyc-management/*') ? 'open' : '' }} ">
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="KYC Management">{{ __('admin-menue-left.kyc_management') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- kyc upload -->
                                @if (PermissionService::has_permission('kyc_upload', 'admin'))
                                    @role('kyc upload')
                                        <li
                                            class="{{ Request::is('admin/kyc-management/kyc-upload-view') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.kyc-upload-view') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="KYC Upload">{{ __('admin-menue-left.kyc_upload') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('kyc_reports', 'admin'))
                                    @role('kyc reports')
                                        <li class="{{ Request::is('admin/kyc-management/kyc-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('kyc.management.report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="KYC Reports">{{ __('admin-menue-left.kyc_reports') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('kyc_request', 'admin'))
                                    @role('kyc request')
                                        <li class="{{ Request::is('admin/kyc-management/kyc-request') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('kyc.management.request') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="KYC Request">{{ __('admin-menue-left.kyc_request') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                    ...
                    @role('manage trade')
                        <li class=" nav-item {{ Request::is('admin/manage-trade/*') ? 'open' : '' }}">
                            <a class="d-flex align-items-center" href="#">
                                <i data-feather="users"></i>
                                <span class="menu-title text-truncate"
                                    data-i18n="Manage Trade">{{ __('admin-menue-left.manage_trade') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- trading report -->
                                @if (PermissionService::has_permission('trading_report', 'admin'))
                                    @role('trading trade report')
                                        <li
                                            class="{{ Request::is('admin/manage-trade/trading-trade-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.trading-trade-report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Basic">{{ __('admin-menue-left.trading_report') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('trade_commission', 'admin'))
                                    @role('trade commission status')
                                        <li
                                            class="{{ Request::is('admin/manage-trade/trade-commission-status') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.trade-commission-status') }}">
                                                <i data-feather="circle"></i>
                                        ...
                                        <li class="{{ Request::is('admin/trading-account-details-live') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                ...
                                                <span class="menu-item text-truncate" data-i18n="Live Trading Account List">
                                                    {{ __('admin-menue-left.live_account') }} </span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                        ...
                                        <li class="{{ Request::is('admin/trading-account-details-demo') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                ...
                                                <span class="menu-item text-truncate" data-i18n="Demo Trading Account List">
                                                    {{ __('admin-menue-left.demo_account') }} </span>
                                            </a>
                                        </li>
                            </ul>
                        </li>
                            ...
                            <ul class="menu-content">
                                ...
                                @if (PermissionService::has_permission('bank_account_list', 'admin'))
                                    @role('bank account list')
                                        <li
                                            class="{{ Request::is('admin/manage_banks/bank_account_list') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                ...
                                @endif
                                <!-- company bank list -->
                                @if (PermissionService::has_permission('company_bank_list', 'admin'))
                                    @role('company bank list')
                                        <li
                                            class="{{ Request::is('admin/manage_banks/company-bank-list') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.company-bank-list') }}">
                                                <i data-feather="circle"></i>
                    ...
                    @role('offers')
                        <li class="check_height nav-item {{ Request::is('admin/voucher/*') ? 'open' : '' }}">
                            ...
                            <ul class="menu-content">
                                ...
                                @endif
                                <!--bonus navbar here-->
                                @if (PermissionService::has_permission('create_bonus', 'admin'))
                                    @role('create bonus')
                                ...
                                @endif
                                <!-- bonus list -->
                                @if (PermissionService::has_permission('bonus_list', 'admin'))
                                    @role('bonus list')
                                ...
                                @endif
                                <!-- offer bonus report -->
                                @if (PermissionService::has_permission('offer_bonus_report', 'admin'))
                                    @role('offer bonus report')
                    ...
                    @role('category manager')
                        <li class="nav-item  {{ Request::is('admin/categories') ? 'active' : '' }}">
                            <a class="d-flex align-items-center" href="{{ url('admin/categories') }}">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="Category Manager">{{ __('admin-menue-left.category_manger') }}</span>
                            </a>
                        </li>
                    @endrole
                @endif
                ...
                <!-- Categor Manager -->
                @if (PermissionService::has_permission('lead_management', 'admin'))
                    @role('category manager')
                        <li class="nav-item  {{ Request::is('admin/lead-management') ? 'active' : '' }}">
                            <a class="d-flex align-items-center" href="{{ url('admin/lead-management') }}">
                                <i data-feather='layers'></i>
                                <span class="menu-title text-truncate"
                                    data-i18n="Lead Management">{{ __('admin-menue-left.lead_management') }}</span>
                            </a>
                        </li>
                    @endrole
                @endif
                ...
                @if (PermissionService::has_permission('social_trade', 'admin'))
                    @role('social trade')
                        <!-- social trade -->
                        <li class="nav-item {{ Request::is('admin/pamm/*') ? 'open' : '' }}">
                            <a class="d-flex align-items-center" href="#">
                                <i data-feather='user-check'></i>
                                <span class="menu-title text-truncate"
                                    data-i18n="Admin-Profile">{{ __('admin-menue-left.social_trade') }}</span>
                                <span id="notiDashboard"
                                    class="badge badge-light-warning rounded-pill ms-auto me-1"></span>
                            </a>
                            <ul class="menu-content">
                                ...
                                @if (PermissionService::has_permission('social_dashboard', 'admin'))
                                    @role('social dashboard')
                                        <li class="{{ Request::is('admin/pamm/copy-dashboard') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.pamm.copy-dashboard') }}">
                                                <i data-feather="circle"></i><span class="menu-item text-truncate"
                                ...
                                @if (PermissionService::has_permission('pamm_manager', 'admin'))
                                    @role('pamm manager')
                                        ...
                                        <li class="{{ Request::is('admin/pamm/master-profit-share-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.pamm.master-profit-share-report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                ...
                                @if (PermissionService::has_permission('copy_trades_report', 'admin'))
                                    @role('copy trades report')
                                        <li class="{{ Request::is('admin/pamm/copy-trades-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.pamm.copy-trade-report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="copy">{{ __('admin-menue-left.copy_trades_report') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('social_trades_activity_reports', 'admin'))
                                    @role('social trades activity report')
                                        <li
                                            class="{{ Request::is('admin/pamm/social-trades-ativity-report') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.social-report') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Basic">{{ __('admin-menue-left.social_trades_report') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                    ...
                                    @role('manage mamm')
                                        <li class="{{ Request::is('admin/pamm/social-trades/manage-mam') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.mamm.manage') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="manage">{{ __('admin-menue-left.manage_mamm') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                <!-- strat pamm request -->
                                @if (PermissionService::has_permission('pamm_request', 'admin'))
                                    @role('pamm request')
                ...
                @endif
                <!--tournaments-->
                <li class="nav-item {{ Request::is('admin/tournament/*') ? 'open' : '' }}">
                    <a class="d-flex align-items-center" href="#">
                        <i data-feather='user-check'></i>
                        <span class="menu-title text-truncate"
                    ...
                    <ul class="menu-content">
                        <!-- tournament settings -->
                        <li class="{{ Request::is('admin/tournament/setting-view') ? 'active' : '' }}">
                            <a class="d-flex align-items-center" href="{{ route('admin.tournament.setting-view') }}">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Admin-Profile">Settings</span>
                            </a>
                        </li>
                        <!-- tournament group list -->
                        <li class="{{ Request::is('admin/tournament/group-list') ? 'active' : '' }}">
                            <a class="d-flex align-items-center" href="{{ route('admin.tournament.group-list') }}">
                                <i data-feather="circle"></i>
                    ...
                    @role('support')
                        <li class=" nav-item {{ Request::is('admin/support/*') ? 'open' : '' }}">
                            <a class="d-flex align-items-center" href="#">
                                ...
                                <span class="menu-title text-truncate"
                                    data-i18n="support">{{ __('admin-menue-left.support') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- client supports -->
                                @if (PermissionService::has_permission('support_tickets', 'admin'))
                                    @role('client ticket')
                                        <li class="{{ Request::is('admin/support/support-ticket') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.support.support-ticket') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Balance Management">{{ __('admin-menue-left.client_tickets') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                ...
                @if (PermissionService::has_permission('settings', 'admin'))
                    @role('settings')
                        <li class=" nav-item {{ Request::is('admin/settings/*') ? 'open' : '' }}"
                            id="left_setting_menu">
                            <a class="d-flex align-items-center" href="#">
                                <i data-feather="settings"></i>
                                <span class="menu-title text-truncate"
                                    data-i18n="Settings">{{ __('admin-menue-left.settings') }}</span>
                            </a>
                            <ul class="menu-content">
                                <!-- crypto address -->
                                @if (PermissionService::has_permission('add_crypto_address', 'admin'))
                                    @role('add crypto address')
                                        <li
                                            class="{{ Request::is('admin/settings/crypto_deposit_settings') ? 'active' : '' }}">
                                ...
                                <!-- currency setup -->
                                <!-- settings -->
                                @if (PermissionService::has_permission('currency_setup', 'admin'))
                                    @role('currency setup')
                                        <li class="{{ Request::is('admin/settings/currency-setup') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" id="smtp_setup"
                                                href="{{ route('admin.settings.currency-setup') }}">
                                                <i data-feather="circle"></i>
                                ...
                                <!-- copy symbol -->
                                <!-- settings -->
                                @if (PermissionService::has_permission('copy_symbols', 'admin'))
                                    @role('copy symbols')
                                        <li class="{{ Request::is('admin/settings/add-copy-symbol') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" id="smtp_setup"
                                                href="{{ route('admin.add-copy-symbol') }}">
                                                <i data-feather="circle"></i>
                                    ...
                                    @role('banner setup')
                                        <li class="{{ Request::is('admin/settings/banner-setup') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" href="{{ route('admin.banner-setup') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Banner Setup">{{ __('admin-menue-left.banner_setup') }}</span>
                                            </a>
                                        </li>
                                        <li class="{{ Request::is('admin/settings/popup-setup') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.settings.popup-setup') }}">
                                                <i data-feather="circle"></i>
                                    ...
                                    @role('currency pair')
                                        <li class="{{ Request::is('admin/settings/currency-pair') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" id="currency-pair"
                                                ...
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate"
                                                    data-i18n="Currency Pair">{{ __('admin-menue-left.currency_pair') }}</span>
                                            </a>
                                        </li>
                                    @endrole
                                @endif
                                ...
                                @if (PermissionService::has_permission('notification_settings', 'admin'))
                                    @role('notification setting')
                                        <li
                                            class="{{ Request::is('admin/settings/notification_setting') ? 'active' : '' }}">
                                ...
                                @if (PermissionService::has_permission('payment_gateways', 'admin'))
                                    @role('payment gateways')
                                        <li class="{{ Request::is('admin/settings/payment-gateways') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" id="trader_setting"
                                                href="{{ route('admin.settings.paymentgateway') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate" data-i18n="Trader Setting">
                                                    Payment Gateways
                                                </span>
                                ...
                                @if (PermissionService::has_permission('notification_template', 'admin'))
                                    @role('notification template')
                                        <li
                                            class="{{ Request::is('admin/settings/notification-templates') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center" id="trader_setting"
                                                href="{{ route('admin.settings.notification-templates') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate" data-i18n="Trader Setting">
                                                    Notification template
                                                </span>
                ...
                @if (PermissionService::has_permission('contest', 'admin'))
                    @role('contest')
                        <li class=" nav-item"><a class="d-flex align-items-center" href="#">
                            ...
                            <ul class="menu-content">
                                @if (PermissionService::has_permission('create_contest', 'admin'))
                                    @role('create contest')
                                ...
                                @endif
                                <!-- contest list -->
                                @if (PermissionService::has_permission('contest_list', 'admin'))
                                    @role('contest list')
                                ...
                                @endif
                                <!-- contest participant -->
                                @if (PermissionService::has_permission('contest_participant', 'admin'))
                                    @role('contest participant')
                                        <li class="{{ Request::is('/admin/contest/contest-participant') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.contest.participant') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate" data-i18n="Group Manager">Contest
                                                    participant
                                                </span>
                ...
                @if (PermissionService::has_permission('contest', 'admin'))
                        <li class=" nav-item"><a class="d-flex align-items-center" href="#">
                            ...
                            <ul class="menu-content">
                                        ...
                                        <li class="{{ Request::is('admin/reward/create-reward') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                        ...
                                        <li class="{{ Request::is('admin/reward/rewards') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                        ...
                                        <li class="{{ Request::is('admin/claim/reward/list') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.claim.reward.list') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate" data-i18n="Group Manager">
                                         ...
                                         <li class="{{ Request::is('admin/reward/participants/list') ? 'active' : '' }}">
                                            <a class="d-flex align-items-center"
                                                href="{{ route('admin.reward.participants.list') }}">
                                                <i data-feather="circle"></i>
                                                <span class="menu-item text-truncate" data-i18n="Group Manager">
