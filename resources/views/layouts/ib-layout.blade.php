...
<!--End of Tawk.to Script-->
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                @if(\App\Services\CombinedService::is_combined('client'))
                <li class="nav-item">
                    <a href="{{route('trader.dashboard')}}" id="btn-cancel-ib" class="nav-link bg-gradient-faded-info btn-close-white bg-gradient-faded-white btn" aria-controls="dashboardsExamples" role="button">
                ...
                @endif
                <li class="nav-item">
                    <a href="{{ route('ib.dashboard') }}" class="nav-link {{ Request::is('ib/dashboard') ? 'active' : '' }}" aria-controls="dashboardsExamples" role="button">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        ...
                        <span class="nav-link-text ms-1">{{ __('ib-menu-left.Dashboard') }}</span>
                    </a>
                </li>
                <!-- myadmin -->
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#dashboardsExamples" class="nav-link {{ Request::is('user/user-admin/*') ? 'active' : '' }}" aria-controls="dashboardsExamples" role="button" aria-expanded="false">
                        ...
                        <span class="nav-link-text ms-1">{{ __('ib-menu-left.my-admin') }}</span>
                    </a>
                    <div class="collapse  {{ Request::is('ib/ib-admin/*') ? 'show' : '' }} " id="dashboardsExamples">
                        <ul class="nav ms-4 ps-3">
                            <!-- profile overview -->
                            @if (PermissionService::has_permission('profile_overview','ib'))
                            <li class="nav-item {{ Request::is('ib/ib-admin/profile-overview') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/ib-admin/profile-overview') ? 'active' : '' }}" href="{{ route('ib.ib-admin.profile-overview') }}">
                                    <span class="sidenav-mini-icon"> P </span>
                                    <span class="sidenav-normal">{{ __('ib-menu-left.profile-overview') }}</span>
                                </a>
                            </li>
                            @endif
                            <!-- settings -->
                            @if (PermissionService::has_permission('settings','ib'))
                            <li class="nav-item {{ Request::is('ib/ib-admin/settings') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/ib-admin/settings') ? 'active' : '' }}" href="{{ route('ib.ib-admin-account-settings') }}">
                                    <span class="sidenav-mini-icon"> S </span>
                                    <span class="sidenav-normal"> {{ __('ib-menu-left.settings') }} </span>
                                </a>
                            </li>
                            @endif
                            <!-- verification -->
                            @if (PermissionService::has_permission('verification','ib'))
                            <li class="nav-item {{ Request::is('ib/ib-admin/account-verification') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/ib-admin/account-verification') ? 'active' : '' }}" href="{{ route('ib.ib-admin-account-verification') }}">
                                    <span class="sidenav-mini-icon"> V </span>
                                    <span class="sidenav-normal">{{ __('ib-menu-left.verification') }}</span>
                                </a>
                            </li>
                            @endif
                            <!-- banking -->
                            @if (PermissionService::has_permission('banking','ib'))
                            <li class="nav-item {{ Request::is('ib/ib-admin/ib-banking') ? 'active' : '' }}">
                                <a class="nav-link  {{ Request::is('ib/ib-admin/ib-banking') ? 'active' : '' }}" href="{{ route('ib.ib-admin.ib-banking') }}">
                                    <span class="sidenav-mini-icon"> B </span>
                                    <span class="sidenav-normal">{{ __('ib-menu-left.banking') }} </span>
                                </a>
                            </li>
                            @endif
                        </ul>
                        ...
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item {{ Request::is('ib/affiliates/clients-deposit-report') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/affiliates/clients-deposit-report') ? 'active' : '' }}" href="{{ route('ib.affilates.deposit-reports') }}">
                                    ...
                                    <span class="sidenav-normal"> {{ __('ib-menu-left.Deposit Reports') }} </span>
                                </a>
                            </li>
                            @endif
                            ...
                            <li class="nav-item {{ Request::is('ib/affiliates/clients-withdraw-report') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/affiliates/clients-withdraw-report') ? 'active' : '' }}" href="{{ url('ib/affiliates/clients-withdraw-report') }}">
                                    ...
                                    <span class="sidenav-normal">{{ __('ib-menu-left.Withdraw Reports') }} </span>
                                </a>
                            </li>
                            @endif
                        </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse {{ Request::is('ib/reports/*') ? 'show' : '' }}" id="reports">
                        <ul class="nav ms-4 ps-3">
                            ...
                            <!--@if (PermissionService::has_permission('ib_balance_trnasfer','ib'))-->
                            ...
                            <!--@endif-->
                            <!-- IB Balance send -->
                            @if (PermissionService::has_permission('ib_balance_send','ib'))
                            <li class="nav-item {{ Request::is('ib/reports/ib-balance/send') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/reports/ib-balance/send') ? 'active' : '' }}" href="{{ url('ib/reports/ib-balance/send') }}">
                            ...
                            @endif
                            <!-- IB Balance Recived -->
                            @if (PermissionService::has_permission('ib_balance_receive','ib'))
                            <li class="nav-item {{ Request::is('ib/reports/ib-balance/recived') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/reports/ib-balance/recived') ? 'active' : '' }}" href="{{ url('ib/reports/ib-balance/recived') }}">
                ...
                <li class="nav-item ">
                    <a data-bs-toggle="collapse" href="#withdraw" class="nav-link {{ Request::is('ib/withdraw/*') ? 'active' : '' }}" aria-controls="withdraw" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                        ...
                        <span class="nav-link-text ms-1">{{ __('ib-menu-left.Withdraw') }}</span>
                    </a>
                    <div class="collapse {{ Request::is('ib/withdraw/*') ? 'show' : '' }}" id="withdraw">
                        <ul class="nav ms-4 ps-3">
                            <!-- bank withdraw -->
                            @if (PermissionService::has_permission('bank_withdraw','ib'))
                            <li class="nav-item {{ Request::is('ib/withdraw/bank-withdraw') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/withdraw/bank-withdraw') ? 'active' : '' }}" href="{{ route('ib.withdraw.bank-withdraw') }}">
                                    <span class="sidenav-mini-icon"> B </span>
                                    <span class="sidenav-normal">{{ __('ib-menu-left.Bank Withdraw') }}</span>
                                </a>
                            </li>
                            @endif
                            <!-- crypto withdraw -->
                            @if (PermissionService::has_permission('crypto_withdraw','ib'))
                            <li class="nav-item {{ Request::is('ib/withdraw/crypto-withdraw') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/withdraw/crypto-withdraw') ? 'active' : '' }}" href="{{ route('ib.withdraw.crypto-withdraw') }}">
                                    <span class="sidenav-mini-icon"> C </span>
                                    <span class="sidenav-normal">{{ __('ib-menu-left.Crypto Withdraw') }}</span>
                                </a>
                            </li>
                            @endif
                        </ul>
                ...
                <li class="nav-item ">
                    ...
                    <div class="collapse {{ Request::is('ib/transfer/*') ? 'show' : '' }}" id="transfer">
                        <ul class="nav ms-4 ps-3">
                            ...
                            @if(\App\Services\Trader\FinanceService::check_op('ib_to_trader'))
                            ...
                            @endif
                            <!-- ib to ib transfer -->
                            @if (PermissionService::has_permission('ib_to_ib_transfer','ib'))
                            @if(\App\Services\Trader\FinanceService::check_op('ib_to_ib'))
                            <li class="nav-item {{ Request::is('ib/transfer/ib-to-ib') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/transfer/ib-to-ib') ? 'active' : '' }}" href="{{ route('ib.transfer.ib-to-ib') }}">
                                    <span class="sidenav-mini-icon"> IB </span>
                                    <span class="sidenav-normal">{{ __('page.ib-to-ib-transfer') }}
                                    </span>
                                </a>
                            </li>
                            @endif
                ...
                <li class="nav-item {{ Request::is('ib/support/*') ? 'active' : '' }}">
                    <a data-bs-toggle="collapse" href="#support" class="nav-link {{ Request::is('ib/support/*') ? 'active' : '' }}" aria-controls="basicExamples" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>Support</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="collapse {{ Request::is('ib/support/*') ? 'show' : '' }}" id="support">
                        <ul class="nav ms-4 ps-3">
                            <!-- support ticket -->
                            @if (PermissionService::has_permission('support_ticket','ib'))
                            <li class="nav-item {{ Request::is('ib/support/ticket') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/support/ticket') ? 'active' : '' }}" href="{{ route('ib.support.ticket') }}">
                                    <span class="sidenav-mini-icon"> S </span>
                ...
                <!-- End  Client support -->
                <!-- Start: Marketing -->
                <li class="nav-item {{ Request::is('ib/marketing/*') ? 'active' : '' }}">
                    <a data-bs-toggle="collapse" href="#marketing" class="nav-link {{ Request::is('ib/marketing/*') ? 'active' : '' }}" aria-controls="marketing" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                            <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>Withdraw</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="collapse {{ Request::is('ib/marketing/*') ? 'show' : '' }}" id="marketing">
                        <ul class="nav ms-4 ps-3">
                            <!-- english -->
                            <li class="nav-item {{ Request::is('ib/marketing/ib-banner') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/marketing/ib-banner') ? 'active' : '' }}" href="{{ route('ib.marketing.ib-banner') }}">
                    ...
                    <div class="collapse {{ Request::is('ib/marketing/*') ? 'show' : '' }}" id="marketing">
                        <ul class="nav ms-4 ps-3">
                            <!-- english -->
                            <li class="nav-item {{ Request::is('ib/marketing/trader-banner') ? 'active' : '' }}">
                                <a class="nav-link {{ Request::is('ib/marketing/trader-banner') ? 'active' : '' }}" href="{{ route('ib.marketing.trader-banner') }}">
        ...
        <div class="sidenav-footer mx-3 mt-3 pt-3">
            <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
                ...
                <div class="card-body text-start p-3 w-100">
                    ...
                    <div class="docs-info">
                        <h6 class="text-white up mb-0">{{ __('ib-menu-left.Need Support?') }}</h6>
                        <p class="text-xs font-weight-bold">{{ __('ib-menu-left.Please send a support tiket') }}</p>
                        <!-- support ticket -->
                        @if (PermissionService::has_permission('support','ib'))
                        <a href="/ib/support/ticket" target="_blank" class="btn btn-white btn-sm w-100 mb-0">{{ __('ib-menu-left.Support Tiket') }}</a>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid py-1 px-3">
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center balance-badge">
                        ...
                        ?>
                        <span class="badge badge-secondary">Balance : $ {{ \App\Services\balance\BalanceSheetService::ib_wallet_balance(auth()->user()->id)}}</span>
                    </div>
