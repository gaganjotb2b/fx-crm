...
<div class="app-content content page-trader-admin">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Lead Manager
                        </h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('manager.index') }}">{{ __('client-management.Home') }}</a>
                                </li>
                                <li class="breadcrumb-item">
    ...
    <script src="{{ asset('manager-assets/js/table-datatable-trader-manager.js') }}"></script>
