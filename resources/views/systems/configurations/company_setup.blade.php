        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Company Setup</h2>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="{{route('system.configarations.company_setup_add')}}" class="mt-2 pt-50" method="POST" enctype="multipart/form-data" id="company-info-form">
                            @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6 mb-1" id="linkedin">
                                                ...
                                                <input type="text" class="form-control linkedin" name="linkedin" placeholder="company linkedin account" value="<?php echo (isset($com_social_info->linkedin) ? $com_social_info->linkedin : ''); ?>" />
                                            </div>
                                            <div class="col-12 col-sm-6 mb-1" id="livechat">
                                                <label class="form-label" for="livechat">LiveChat</label>
                                                <input type="text" class="form-control livechat" name="livechat" placeholder="company livechat account" value="<?php echo (isset($com_social_info->livechat) ? $com_social_info->livechat : ''); ?>" />
                                            </div>
