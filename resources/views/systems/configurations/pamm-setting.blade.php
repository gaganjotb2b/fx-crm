        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">PAMM Configuration</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">{{__('category.Home')}}</a></li>
                                <li class="breadcrumb-item"><a href="#">Configurations</a></li>
                                <li class="breadcrumb-item active">PAMM Configuration</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header border-bottom">
                            <div class="card my-0 py-0">
                                <div class="card-body my-0 py-0">
                                    <h4 class="card-title">PAMM Configurations</h4>
                                </div>

                            </div>
                            <button type="submit" class="btn btn-primary" onclick="activePamm()">Active PAMM</button>
                        </div>
                    </div>
                </div>
                <div class="col-4">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.status == false) {
                    ...
                    toastr['error']('Failed To Update!', 'PAMM Configuration', {
                ...
                if (data.status == true) {
                    toastr['success'](data.message, 'PAMM Configuration', {
                        showMethod: 'slideDown',
                        hideMethod: 'slideUp',
                        closeButton: true,
                        tapToDismiss: false,
