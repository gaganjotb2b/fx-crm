...
@section('title','Admin module Setting')
@section('vendor-css')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Admin {{__('page.settings')}}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Admin {{__('page.settings')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header border-bottom mb-0">
                            <div class="card my-0 py-0 w-100">
                                <div class="card-body my-0 py-0 d-flex justify-content-between">
                                    <h4 class="card-title float-start d-flex">{{__('page.admin')}} {{__('page.settings')}}</h4>
...
<script src="{{asset('common-js/admin-settings.js')}}" type="text/javascript"></script>
@stop
<!-- BEGIN: page JS -->