...
@section('title', 'Deposit Migration')
@section('vendor-css')
    ...
    <div class="content-wrapper container-xxl p-0">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Deposit Migration
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <form class="card-body" action="{{ route('system.deposit-migration-store') }}" method="post" id="import-csv-form" enctype="multipart/form-data">
                            <div class="p-5">
                                <div class="row custom-options-checkable g-1">
                                    <div class="col-md-12">
                                        ...
                                        <label class="custom-option-item text-center p-1" for="type1">
                                            ...
                                            <small>Choose Deposit Migration File For Trader</small>
                                        </label>
                                    </div>
                                </div>
                                @csrf
