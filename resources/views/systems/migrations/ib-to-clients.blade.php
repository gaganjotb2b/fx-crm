    ...
    <div class="content-wrapper container-xxl p-0">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">IB Refer to Clients
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <form class="card-body" action="{{ route('system.migration.clients-reference.store') }}" method="post" id="import-csv-form" enctype="multipart/form-data">
                            <div class="p-5">
                                <div class="row custom-options-checkable g-1">
                                    <div class="col-md-6">
                                        <input class="custom-option-item-check" type="radio" name="type" id="type2" value="ib" checked />
                                        <label class="custom-option-item text-center text-center p-1" for="type2">
                                            <i data-feather="user" class="font-large-1 mb-75"></i>
                                            <span class="custom-option-item-title h4 d-block">Clients(Trader)</span>
