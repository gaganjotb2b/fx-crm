    ...
    <div class="content-wrapper container-xxl p-0">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">User asigne to manager
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <form class="card-body" action="{{ route('system.manager-asigne.store') }}" method="post" id="import-csv-form" enctype="multipart/form-data">
                            <div class="p-5">
                                @csrf
