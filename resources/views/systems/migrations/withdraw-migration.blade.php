...
@section('title', 'Withdraw Migration')
@section('vendor-css')
    ...
    <div class="content-wrapper container-xxl p-0">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Withdraw Migration
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <form class="card-body" action="{{ route('system.withdraw-migration-store') }}" method="post" id="import-csv-form" enctype="multipart/form-data">
                            <div class="p-5">
                                <div class="row custom-options-checkable g-1">
                                    <div class="col-md-12">
                                        ...
                                        <label class="custom-option-item text-center p-1" for="type1">
                                            ...
                                            <span class="custom-option-item-title h4 d-block">Trader & IB</span>
                                            <small>Choose Withdraw Migration File For Trader & IB</small>
                                        </label>
                                    </div>
                                </div>
                                @csrf
                                ...
                                <div class="mb-1 row mt-3">
                                    <label for="csv_file" class="col-sm-3 col-form-label">Select File<span class="text-danger">&#9734;</span></label>
                                    <div class="col-sm-9">
