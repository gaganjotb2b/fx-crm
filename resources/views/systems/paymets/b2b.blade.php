        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">B2B {{__('page.settings')}}</h2>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                            <div class="card p-0">
                                                ...
                                                <form action="" method="POST" enctype="multipart/form-data" id="b2b_settings_form">
                                                    @csrf
                                                    <div class="row">
                                                        <h5 class="mb-2">B2B Settings</h5>
                                                        <!-- API URL -->
                                                        ...
                                                        <div class="col-12 mt-2">
                                                            <div class="p-0 m-0">
                                                                <button type="button" class="btn btn-primary text-center" id="btn-submit-b2b-settings" onclick="_run(this)" data-el="fg" data-form="b2b_settings_form" data-loading="<div class='spinner-border spinner-border-sm' role='status'><span class='visually-hidden'>Loading...</span></div>" data-callback="b2b_submit_callback" data-btnid="btn-submit-b2b-settings" style="width:200px; float:right">Submit request</button>
                                                            </div>
                                                        </div>
                                                </form>
