...
@section('title','Help2pay Setting')
@section('vendor-css')
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Help2pay {{__('page.settings')}}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Help2pay</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="border-start-3 border-start-primary p-1 bg-light-primary mb-1">
                                    Help2Pay is a comprehensive payment gateway which offers robust, real-time and market-tuned solutions.
                                </div>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                            <div class="card p-0">
                                                ...
                                                <form action="" method="POST" enctype="multipart/form-data" id="help2pay_settings_form">
                                                    @csrf
                                                    <div class="row">
                                                        <h5 class="mb-2">Help2pay Settings</h5>
                                                        <!-- Mercent Code -->
                                                        <div class="col-12 col-sm-6 mb-1 pb-2 mt-1">
                                                            <label class="form-label">Mercent Code</label>
                                                            <div class="input-group">
                                                                <input type="text" name="mercent_code" class="form-control flatpickr-basic" placeholder="Mercent Code">
                                                            </div>
                                                        </div>
                                                        <!-- User Name -->
                                                        <div class="col-12 col-sm-6 mb-1 pb-2">
                                                            ...
                                                            <div id="myDropdown" class="dropdown-content form-group ">
                                                                <input type="text" name="user_name" class="form-control flatpickr-basic" placeholder="User Name">
                                                            </div>
                                                        </div>
                                                        <!-- User Password -->
                                                        <div class="col-12 col-sm-6 mb-1 pb-2">
                                                            ...
                                                            <div class="input-group input-group-merge form-password-toggle">
                                                                <input type="password" class="form-control form-control-merge" id="password" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" tabindex="2" />
                                                        ...
                                                        <div class="col-12 col-sm-6 mb-1 pb-2">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="api_url" class="form-control flatpickr-basic" placeholder="API URL" value="">
                                                            </div>
                                                        </div>
                                                        <div class="col-12 mt-2">
                                                            <div class="p-0 m-0">
                                                                <button type="button" class="btn btn-primary text-center" id="btn-submit-help2pay-settings" onclick="_run(this)" data-el="fg" data-form="help2pay_settings_form" data-loading="<div class='spinner-border spinner-border-sm' role='status'><span class='visually-hidden'>Loading...</span></div>" data-callback="help2pay_submit_callback" data-btnid="btn-submit-help2pay-settings" style="width:200px; float:right">Submit request</button>
                                                            </div>
                                                        </div>
                                                </form>
