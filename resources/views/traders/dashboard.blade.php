    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                    href="javascript:;">{{ __('page.dashboard') }}</a></li>
...
@section('content')
    ...
    <div class="container-fluid py-4">
        <!-- contest alert -->
        @php $banner = 0; @endphp
        @if (\App\Services\contest\ContestService::client_has_contest(auth()->user()->id)['status'] && $banner != 0)
            <div class="row">
                <div class="col-lg-12">
                    <div class="alert alert-dismissible fade show z-index-1 p-0 bg-white" role="alert">
                        <div class="row">
                            @php $i = 1; @endphp
                            @foreach (\App\Services\contest\ContestService::get_all_active_contest(auth()->user()->id) as $value)
                                @if ($i <= 2)
                                    <div
                                        class="col-md-{{ \App\Services\contest\ContestService::col_size(auth()->user()->id) }}">
                                        <a href="{{ route('users.participate-contest') }}"><img class="img-fluid"
                                                src="{{ asset('Uploads/contest/' . $value->popup_image) }}"
                                                alt="{{ $value->contest_name }}"></a>
                                    </div>
                                @endif
                                @php $i++ @endphp
                            @endforeach
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="d-flex flex-column h-100">
                                    <h2 class="font-weight-bolder mb-0">{{ ucwords(auth()->user()->name) }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="numbers">
                                            ...
                                            <h5 class="font-weight-bolder mb-0">
                                                ...
                                                <span class="text-success text-sm font-weight-bolder"
                                                    ...
                                                    {{ $all_fun->get_pending_balance(auth()->user()->id) ? $all_fun->get_pending_balance(auth()->user()->id) : 0 }}</span>
                                            </h5>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-capitalize font-weight-bold">
                                                {{ __('page.total_withdraw') }}
                                            </p>
                                            <h5 class="font-weight-bolder mb-0">
                                                $ {{ $all_fun->get_total_withdraw(auth()->user()->id) }}
                                                <span class="text-danger text-sm font-weight-bolder"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Pending withdraw">-${{ \App\Services\BalanceService::trader_total_pending_withdraw(auth()->user()->id) }}</span>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-capitalize font-weight-bold">
                                                {{ __('page.trader') }} {{ __('page.volume') }}
                                            </p>
                                            <h5 class="font-weight-bolder mb-0">
                                                {{ $all_fun->get_total_volume(auth()->user()->id) }}
                                                <span class="text-danger text-sm font-weight-bolder"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Todays volume">{{ $all_fun->get_today_volume(auth()->user()->id) }}</span>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                            ...
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-capitalize font-weight-bold">
                                                {{ __('page.total_deposit') }}
                                            </p>
                                            <h5 class="font-weight-bolder mb-0">
                                                ${{ $all_fun->get_total_deposit(auth()->user()->id) }}
                                                <span class="text-success text-sm font-weight-bolder"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Pending deposit">${{ \App\Services\AllFunctionService::trader_total_deposit(auth()->user()->id, 'pending') }}</span>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            ...
                                            <h5 class="font-weight-bolder mb-0">
                                                ${{ $all_fun->get_wta_transfer(auth()->user()->id) }}
                                                <span class="text-danger text-sm font-weight-bolder"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Pending Account Deposit">{{ $all_fun->get_wta_transfer_pending(auth()->user()->id) }}</span>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            ...
                                            <h5 class="font-weight-bolder mb-0">
                                                ${{ $all_fun->get_atw_transfer(auth()->user()->id) }}
                                                <span class="text-success text-sm font-weight-bolder"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Pending Account Withdraw">${{ $all_fun->get_atw_transfer_pending(auth()->user()->id) }}</span>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                        ...
                        <div class="card trade_account_card_dash">
                            <div class="card-header pb-0 p-3">
                                <div class="d-flex justify-content-between">
                                    <h6 class="mb-2">{{ __('page.trading_accounts') }}</h6>
                                </div>
                            </div>
                            ...
                            @else
                                <div class="alert alert-warning alert-dismissible fade show m-3" role="alert">
                                    ...
                                    <span class="alert-text">
                                        ...
                                        <a href="{{ route('user.trading.open-account') }}"
            ...
            <div class="col-lg-5 mb-lg-0 mb-4">
                <div class="card z-index-2">
                    <div class="card-header pb-2">
                        <h6> {{ __('page.seven_days_trade') }}</h6>
                    </div>
                    <div class="card-body p-3">
                        ...
                        <div class="container border-radius-lg">
                            <div class="row">
                                <div class="col-4 py-3 ps-0">
                                    <a class="col-4 py-3 ps-0" href="{{ meta_download_link('windows') }}"
                                        target="_blank">
                                ...
                                <div class="col-4 py-3 ps-0">
                                    <a class="col-4 py-3 ps-0" href="{{ meta_download_link('android') }}"
                                        target="_blank">
                                        <div class="d-flex mb-2">
            ...
            <div class="modal fade" id="contest-popup" tabindex="-1" role="dialog"
                ...
                <form class="modal-dialog modal-danger modal-dialog-centered modal-lg" role="document">
                    ...
                    <input type="hidden" name="contest_id"
                        value="{{ array_key_exists('id', $contest_data) ? $contest_data['id'] : '' }}">
                        ...
                        <div class="modal-body">
                            <div class="py-3 text-center">
                                <div class="row">
                                    <div class="col-md-12">
                                        <a href="{{ route('users.participate-contest') }}"><img class="img-fluid"
                                                src="{{ array_key_exists('file_url', $contest_data) ? $contest_data['file_url'] : '' }}"
                                                alt="{{ array_key_exists('contest_name', $contest_data) ? $contest_data['contest_name'] : '' }}"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!--            value="{{ $popup_data ? $popup_data['popup_id'] : '' }}">-->
    <!--        <input type="hidden" id="popup-visibility"-->
    <!--            value="{{ $popup_visibility }}">-->
    <!--        <div class="modal-content bg-transparent border-0">-->
    <!--            <div class="modal-body">-->
    <!--                <div class="py-3 text-center">-->
    <!--                    <div class="row">-->
    ...
    <!--                            <a href="">-->
    <!--                                <img class="img-fluid"-->
    <!--                                    src="{{ array_key_exists('file_url', $popup_data) ? $popup_data['file_url'] : '' }}"-->
    <!--                                    alt="">-->
    <!--                            </a>-->
    <!--                        </div>-->
    <!--                    </div>-->
