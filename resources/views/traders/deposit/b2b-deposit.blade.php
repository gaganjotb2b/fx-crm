...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">B2Bin Pay</li>
    </ol>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <div class="multisteps-form__form">
                            <form method="post" action="{{route('user.deposit.b2b-client')}}" id="form-b2b">
                                @csrf
                                <!--single form panel-->
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                                    <div class="row text-center">
                                        <div class="col-10 mx-auto">
                                            <h5 class="font-weight-normal">Crypto Currency Deposit (B2Bin Pay)</h5>
                                            <p></p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-12 col-sm-6 mt-4 mt-sm-0 text-start">
                                                ...
                                                <div class="form-group al-error-solve">
                                                    ...
                                                    <select id="crypto-currency" class="form-control form-select" name="crypto_currency">
                                                        <option value="">Select Crypto Currency</option>
                                                        <option value="BTC" title="Bitcoin" data-iso="1000">BTC</option>
                                                        <option value="ETH" title="Ethereum" data-iso="1002">ETH</option>
                                                        <option value="LTC" title="Litecoin" data-iso="1003">LTC</option>
                                                        <option value="BNB" title="Binance Smart Chain" data-iso="1125">BNB</option>
                                                        <option value="USDT" title="Ethereum" data-iso="2015">USDT</option>
                                                        <option value="USDT" title="Binance Smart Chain" data-iso="2065">USDT</option>
                                                        <option value="USDT" title="TRON" data-iso="2145">USDT</option>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row  mt-4">
                                            ...
                                            <div class="col-12 col-sm-8 mt-4 mt-sm-0 text-start">
                                                <div class="col-6 mx-auto">
                                                    ...
                                                    <button class="btn bg-gradient-primary ms-auto mb-0 float-end" type="button" title="Next" id="btn-b2b" style="width: 200px" data-btnid="btn-b2b" data-callback="b2b_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="form-b2b" data-el="fg" onclick="_run(this)">{{__('page.next')}}</button>
                                                </div>
                                            </div>
...
<script>
    ...
    function b2b_call_back(data) {
        if (data.status == true) {
            notify('success', data.message, 'B2Bin PAY');
            window.location = data.redirect_to;
        } else {
            notify('error', data.message, 'B2Bin PAY');
        }
    ...
    function currency_convert(convart_from, input_id, convart_to_id) {
        $(document).on("blur keyup", "#" + input_id, function() {
            ...
            let crypto_type = $("#crypto-currency").val();
