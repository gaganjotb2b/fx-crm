...
<div class="container-fluid py-4">
    <div class="row custom-height-con">
        <div class="col-12 text-center">
            ...
            <h5 class="text-secondary font-weight-normal">Match2Pay deposit status. Don't refresh this page while status changes to done or approved.</h5>
                                        ...
                                        <div class="col-12 mt-4 mt-sm-0 text-start pb-5">
                                            <table class="table">
                                                <tr>
                                                    <th>Amount</th>
                                                    <td>
                                                        {{(session()->has('amount'))?session('amount'):''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>status</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{(session()->has('currency'))?session('currency'):''}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Crypto address</th>
                                                    <td>
                                                        {{(session()->has('crypto_address'))?session(crypto_address):''}}
                                                    </td>
                                                </tr>
