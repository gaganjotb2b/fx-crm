                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <div class="multisteps-form__form">
                            ...
                            <form method="post" action="{{route('user.deposit.paypal.api')}}" id="form-paypal-deposit">
                                @csrf
                                <!--single form panel-->
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                                    <div class="row text-center">
                                        <div class="col-10 mx-auto">
                                            <h5 class="font-weight-normal">Balance Transfer With PayPal</h5>
                                            <p></p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-12 col-sm-6 mt-4 mt-sm-0 text-start">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="email" class="form-input form-control" disabled value="{{auth()->user()->email}}">
                                                </div>
                                                <!-- amount usd -->
                                                <div class="form-group">
                                                    <label for="user-email">Amount(USD)</label>
                                                    <input type="text" name="amount" class="form-input form-control" value="" placeholder="0">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row  mt-4">
                                            ...
                                            <div class="col-12 col-sm-8 mt-4 mt-sm-0 text-start">
                                                <div class="col-6 mx-auto">
                                                    ...
                                                    <button class="btn bg-gradient-primary ms-auto mb-0 float-end" type="button" title="Next" id="btn-submit-request" data-btnid="btn-submit-request" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" style="width: 200px" data-callback="payal_deposit_callback" data-form="form-paypal-deposit" onclick="_run(this)">Submit Request</button>
                                                </div>
                                            </div>
...
<script>
    function payal_deposit_callback(data) {
        if (data.status) {
            notify('success', data.message, 'Paypal deposit');
            window.location.href = data.checkout_url;
            console.log(data.checkout_url);
        } else {
            notify('error', data.message, 'Paypal deposit');
        }
    }
</script>
@stop