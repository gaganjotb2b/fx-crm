...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Economic Calendar</a></li>
...
@endphp
<div class="container-fluid py-4 economic-calendar-div">
    <iframe class="w-100 h-100" src="https://tools.fxcrm.net/calendar/" frameborder="0"></iframe>
</div>
<!-- include footer -->
