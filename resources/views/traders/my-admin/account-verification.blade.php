...
@section('title', 'User Account Verification')
@section('page-css')
...
<div class="container-fluid py-4">
    <div class="row custom-height-con">
        <div class="col-12 text-center ">
            <h3 class="mt-5">{{ __('page.kyc-verifications') }}</h3>
            <h5 class="text-secondary font-weight-normal text-kyc-verification">
                {{ __('page.need-your-identity-verification') }}
            </h5>
            <div class="multisteps-form mb-5 custom-height-con">
                <!--progress bar-->
                <div class="row">
...
<script src="{{ asset('trader-assets/assets/js/scripts/pages/account-verification.js') }}"></script>
<script>
    // // check adhar card
    ...
    function check_document_type() {
        let $type = $("#exampleFormControlSelect1 option:selected").text();
        console.log($type);
    ...
    // $('#kycTab').click(function() {
    //     // $('#custom_avatar_div').css('display','none');
    //     $('#myKyc').parent('#tab-id-proof').parent().removeClass('col-sm-8');
    // })
    // $("[href='#address-proof']").click(function() {
    //     $('#myKyc').parent('#tab-id-proof').parent().addClass('col-sm-8');
    // });
    // $("[href='#tab-pan-id-proof']").click(function() {
    //     $('#myKyc').parent('#tab-id-proof').parent().addClass('col-sm-8');
    // });
</script>
@stop