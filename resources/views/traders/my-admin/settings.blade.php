...
<style>
    ...
    @media only screen and (max-width: 412px) {
        ...
        #google_auth_setup_form {
            margin: 0 !important;
        }

        #google_auth_setup_form li:not(:first-child) {
            /* padding: inherit; */
            padding-left: 0;
            padding-right: 0;
        }

        #google_auth_setup_form .col-8.p-4.vertical-line {
            padding: 0 !important;
        }

        #google_auth_setup_form #qrcode img.z-index-2.position-relative {
            width: 61px;
        }

        #google_auth_setup_form .code_in.col-8.p-4.last-connector {
            padding: 0 !important;
            margin-left: 14px;
        }
    ...
    /* a.nav-link.mb-0.px-0.py-1.cpass.active {
        display: block;
        width: 100% !important;
...
<div class="tab-content">
    <div id="profile-settings" class="tab-pane active" style="min-height:calc(100vh - 228px)">
            ...
            <div class="row mb-5">
                <div class="col-lg-4">
                    <div class="card position-sticky top-1 nav-wrapper position-relative end-0">
                        <ul class="nav flex-column bg-white border-radius-lg p-3 nav-pills nav-fill flex-column p-1" role="tablist">
                            ...
                            <!-- nav item change transaction password -->
                            <li class="nav-item">
                            ...
                            @if (
                            $adminOtpSetting->deposit == true ||
                            $adminOtpSetting->withdraw == true ||
                            $adminOtpSetting->transfer == true ||
                            $adminOtpSetting->account_create == true)
                            <!-- nav item otp verification -->
                            <li class="nav-item">
                                <a class="nav-link text-body mb-2 px-3 py-1 text-start btn-otp-block settings-nav-link" data-bs-toggle="tab" href="#otpVerification" role="tab" aria-controls="preview" aria-selected="true">
                                    <div class="icon me-2">
                ...
                <div class="col-lg-8 mt-lg-0 mt-4">
                    ...
                    <div class="tab-content">
                        <div id="profile" class="tab-pane active">
                            ...
                            <div class="card mt-4" id="basic-info">
                                ...
                                <form class="card-body pt-0" action="{{ route('user.user-admin-settings.basic-info') }}" method="POST" id="basic-info-form">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <label class="form-label mt-4">{{ __('page.date_of_birth') }}</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="button" data-label="Submit Request" id="btn-info-submit-request" data-btnid="btn-info-submit-request" data-callback="user_info_call_back" data-loading="<i class='fa-spinner fas fa-circle-notch'></i>" data-form="basic-info-form" data-el="fg" onclick="_run(this)" class="btn bg-gradient-primary ms-auto mb-0 w-lg-25 mt-4 float-end">{{ __('page.submit-request') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div id="change-password" class="tab-pane fade vh-100">
                            <!-- Card Change Password -->
                            <div class="card" id="password-card">
                                <div class="card-header">
                                    <div class="row">
                                        <!-- <div class="col-6">
                                            <h5>{{ __('page.change-password') }}</h5>
                                        </div>
                                        <div class="col-6">
                                            <form class="card-body p-0 m-0" action="{{ route('user.user-admin.reset.password') }}" id="user_reset_pass_form" method="post">
                                                @csrf
                                                <div class="row float-end">
                                                    <div class="">
                                                        <button type="button" data-label="Submit Request" id="user_reset_pass" data-btnid="user_reset_pass" data-callback="password_reset_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="user_reset_pass_form" data-el="fg" onclick="_run(this)" class="btn bg-gradient-warning ms-auto float-end btn-submit-request">Reset Password</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div> -->
                                        ...
                                        <div class="nav-wrapper position-relative end-0 pt-3 col-12">
                                            <ul class="nav nav-pills nav-fill p-1 trans-tab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link mb-0 px-0 py-1 cpass active" data-bs-toggle="tab" href="#inner-change-password" role="tab" aria-controls="profile" aria-selected="true">
                                                        Change Password
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link mb-0 px-0 py-1 cpass" data-bs-toggle="tab" href="#inner-reset-password" role="tab" aria-controls="dashboard" aria-selected="false">
                                                        Reset Password
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="col-12 tab-content" id="inner-pills-tabContent">
                                    <div class="tab-pane fade show active" id="inner-change-password" role="tabpanel" aria-labelledby="pills-home-tab">
                                        ...
                                        <form class="card-body pt-0" action="{{ route('user.user-admin-settings.update-password') }}" id="password-update-form" method="post">
                                            @csrf
                                            <div class="row gx-4">
                                                <div class="col-4">
                                                    <!-- <h5 class="mt-0">{{ __('page.password-requirements') }}</h5> -->
                                                ...
                                                <div class="col-6 mx-auto">
                                                    ...
                                                    <div class="password_gen">
                                                        <div class="form-group pasGen-form-group password_ch_toltip">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control copy_password check_password_chrac copy-pass-input" name="new_password" data-size="16" data-character-set="a-z,A-Z,0-9,#" rel="gp" placeholder="New Password" type="password" id="new_password">
                                                        ...
                                                        <div class="form-group">
                                                            <input class="form-control password_gen" rel="gp" type="password" id="confirm_password" name="confirm_password" placeholder="Confirm password">
                                                        </div>
                                                    </div>

                                                    <button type="button" data-label="Submit Request" id="btn-submit-request-pass" data-btnid="btn-submit-request-pass" data-callback="password_update_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="password-update-form" data-el="fg" onclick="_run(this)" class="btn bg-gradient-primary ms-auto float-end mb-0 mt-4 btn-submit-request" style="width:200px">{{ __('page.submit-request') }}</button>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="inner-reset-password" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        <!-- reset password form -->
                                        <form class="card-body pt-0" action="{{ route('user.user-admin.reset.password') }}" id="user_reset_pass_form" method="post">
                                            @csrf
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-6 mx-auto" id="email_verification_section">
                                                    <div class="form-group ">
                                                        <h6 class="mb-5">Create New Password</h6>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="text-center">
                                                            <button type="button" data-label="Submit Request" id="user_reset_pass" data-btnid="user_reset_pass" data-callback="password_reset_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="user_reset_pass_form" data-el="fg" onclick="_run(this)" class="btn bg-gradient-primary ms-auto float-end mb-0 mt-4 btn-submit-request">Reset Password</button>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div id="change-transaction-password" class="tab-pane fade vh-100">
                            ...
                            <div class="card" id="password-card">
                                {{-- <div class="card-header">
                                    <h5>{{__('page.change_transaction_password')}}</h5>
                            </div> --}}
                            <div class="card-body p-4">
                                <ul class="nav nav-pills mb-5 bg-transparent" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active w-100" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Change
                                            Transaction Pin</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link w-100" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Reset Transaction Pin</button>
                                    </li>
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                        ...
                                        <form class="card-body pt-0" action="{{ route('user.user-admin-settings.update-transaction-password') }}" id="transaction-password-update-form" method="post">
                                            @csrf
                                            <div class="row gx-4">
                                                <div class="col-4">
                                                    <p class="text-muted mb-2 text-strong">
                                                ...
                                                <!--Start: forgot transaction password -->



                                                <div class="col-6 mx-auto" id="transaction-password-section">
                                                    <label class="form-label">Current Transaction Pin</label>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="password_gen ">
                                                        <div class="form-group pasGen-form-group password_ch_toltip">
                                                            ...
                                                            <button class="copy_btn" type="button">Copy</button>
                                                            <label for="old-password">New Transaction Pin</label>
                                                            <div class="input-group">
                                                        ...
                                                        <label class="form-label">Confirm New Transaction Pin</label>
                                                        <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        ...
                                        <form class="card-body pt-0" action="{{ route('user.user-admin.settings.create.transection.password') }}" id="create_password_form" method="post">
                                            @csrf
                                            <div class="row gx-4">
                                                <div class="col-4">
                                                    <p class="text-muted mb-2 text-strong">
                                                ...
                                                <!--Start: find othenticated user -->
                                                <div class="col-6 mx-auto" id="email_verification_section">
                                                    <div class="form-group ">
                                                        <h6 class="mb-5">Create Transaction Pin</h6>
                                                        <div class="mb-3">
                                                            <input type="email" name="forgot_email" class="form-control forgot_email" placeholder="Find Your Account By Email" value="{{ isset(auth()->user()->email) ? auth()->user()->email : ''}}" aria-label="Email" readonly required>
                                                        </div>
                                                        <input type="hidden" id="submit_email_form" name="submit_email_form" value="ftp_email">
                    ...
                    <!-- 2fa tab content -->
                    <div id="two-fa" class="tab-pane fade vh-100">
                        <!-- Card two-fa -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-google-auth row" style="display: none">
                                    ...
                                    <ul class="col-11 mx-auto" id="step">
                                        ...
                                        <form class="mx-2" action="{{ route('user.user-admin-settings.google-security-setting') }}" method="post" enctype="multipart/form-data" id="google_auth_setup_form">
                                            @csrf
                    ...
                    <div id="accounts" class="tab-pane fade vh-100">
                        <!-- Card Accounts -->
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="tab-content mt-5" id="accont-content">
                                        <div class="tab-pane fade" id="account-create" role="tabpanel" aria-labelledby="account-create">
                                            <form class="form-demo" action="{{ route('user.trading-account.open-demo-account-form') }}" method="post" id="demo-account-form">
                                                @csrf
                                                <div class="row">
                    ...
                    <div id="notifications" class="tab-pane fade vh-100">
                        <!-- Card Notifications -->
                    ...
                    <div id="sessions" class="tab-pane fade vh-100">
                        <!-- Card Sessions -->
                        <div class="card" id="sessions-card" style="min-height: 323px;">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div id="login-session-card">
                                    @for ($i = 0; $i < count($login_history); $i++) @php $device=$i + 1; $browser=$login_history["device_$device"]['name']; $browser_logo=AllFunctionService::login_browser($browser); $login_device=$login_history["device_$device"]['platform']; $device_icon=AllFunctionService::login_device($login_device); $ip_address=$login_history["device_$device"]['ip_address']; $locationData=Location::get($ip_address[3]); $country=isset($locationData->countryName) ? $locationData->countryName : (isset($user_descriptions->name) ? $user_descriptions->name : '');
                                        $login_at = $login_history["device_$device"]['login_at'];
                                        @endphp
                    ...
                    <div id="delete-account" class="tab-pane fade vh-100">
                        <!-- Card Delete Account -->
...
<div id="tab-social" class="tab-pane fade vh-100">
    <div class="container-fluid py-4 my-3">
        <div class="row">
            <div class="col-8 text-center mx-auto">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <form action="{{ route('user.user-admin-settings.add-update') }}" method="post" id="social-info-form">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 mx-auto mt-3">
                                    <div class="form-group">
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" style="padding-left: 36px !important;" id="fb_link" name="fb_link" value="{{ isset($social_link->facebook) ? $social_link->facebook : '' }}" placeholder="https://" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mx-auto mt-3">
                                    <div class="form-group">
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" style="padding-left: 36px !important;" id="twitter_link" name="twitter_link" value="{{ isset($social_link->twitter) ? $social_link->twitter : '' }}" placeholder="https://" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mx-auto mt-3">
                                    <div class="form-group">
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" style="padding-left: 36px !important;" id="skype_link" name="skype_link" value="{{ isset($social_link->skype) ? $social_link->skype : '' }}" placeholder="https://" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mx-auto mt-3">
                                    <div class="form-group">
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" style="padding-left: 36px !important;" id="linkedin_link" name="linkedin_link" value="{{ isset($social_link->linkedin) ? $social_link->linkedin : '' }}" placeholder="https://" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 mx-auto mt-3">
                                ...
                                <div class="col-md-6 mx-auto mt-3">
                                    <div class="form-group">
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" style="padding-left: 36px !important;" id="telegram_link" name="telegram_link" value="{{ isset($social_link->telegram) ? $social_link->telegram : '' }}" placeholder="https://" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="card multisteps-form__panel position-relative p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                                    <div class="row text-center">
                                        <div class="col-10 mx-auto">
                                            ...
                                            <p>{{ __('page.let-us-know-your-name-and-email-address-use-an-address-you-dont-mind-other-users-contacting-you-at') }}
                                            </p>
                                        </div>
                                    </div>
...
<script>
    ...
    function user_info_call_back(data) {
        ...
        if (data.status == false) {
            notify('error', data.message, 'User Details');
        }
    ...
    var trade_report = dt_fetch_data(
        '/user/user-admin/account-settings/accounts-dt', //request url
        [{
                "data": "account"
            }, //collumns
            {
    ...
    $(document).on("click", ".btn-session-block", function() {
        ...
        $.ajax({
            url: "/user/user-admin/sessions/login-device",
            method: 'get',
            dataType: 'json',
    ...
    // otp verification
    $(document).on("click", ".btn-otp-block", function() {
...
<script>
    ...
    $(document).on('change', '#noAuthCheck', function(event) {
        ...
        $.ajax({
            url: '/user/user-admin/settings/security-setting/' + check_auth,
            method: 'POST',
            dataType: 'json',
            cache: false,
            contentType: false,
    ...
    $('.password_ch_toltip').find('.check_password_chrac').keyup(function() {
        ...
        if (pwdLength.test(s)) {
            ...
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-length i').removeClass(
                'fa-info-circle');
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-length i').addClass(
                'fa-check-circle');
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-length i').removeClass(
                "fa-times-circle");
        } else {
        ...
        if (pwdUpper.test(s) && pwdLower.test(s)) {
            ...
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-upperlower i').removeClass(
                'fa-info-circle');
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-upperlower i').addClass(
                'fa-check-circle');
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-upperlower i').removeClass(
                "fa-times-circle");
        } else {
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-upperlower i').css("color",
                "#E84B21");
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-upperlower i').removeClass(
                "fa-check-circle");
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-upperlower i').removeClass(
        ...
        if (pwdNumber.test(s)) {
            ...
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-number i').removeClass(
                'fa-info-circle');
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-number i').addClass(
                'fa-check-circle');
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-number i').removeClass(
                "fa-times-circle");
        } else {
        ...
        if (pwdSpecial.test(s)) {
            ...
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-special i').removeClass(
                'fa-info-circle');
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-special i').addClass(
                'fa-check-circle');
            $(this).closest('.password_ch_toltip').find('.pwd-restriction-special i').removeClass(
                "fa-times-circle");
        } else {
    ...
    $('#create_tp_section').hide();
    // forgot password property
    // $(document).on('click', '.forgot_transaction_password', function() {
    //     $('#transaction-password-section').toggle(2000);
    //     $('#email_verification_section').toggle(2000);
    //     $('#submit_email_form').val("ftp_email");
    // });
    ...
    function findTPemailCallBack(data) {
        if (data.status == true) {
            ...
            notify('success', data.message, "Reset Transaction Pin");
            $("#create_password_btn").prop('disabled', true);
        } else {
            notify('error', data.message, "Reset Transaction Pin");
        }
    }
    // forgot password verification callback
    function ftpVerifyOTPcallBack(data) {
        if (data.status == true) {
            $('#otp_verification_section').toggle(2000);
            $('#create_tp_section').toggle(2000);
            $('#submit_otp_form').val("");
            $('#create_tp_form').val("create_tp");

            $('.ftp_email').val(data.ftp_email);
            $('.new_forgot_tp').val("");
            notify('success', data.message, "Forgot Transaction Pin");

        } else {
            notify('error', data.message, "Forgot Transaction Pin");
        }
    }
    // create new password callback
    function createTPcallBack(data) {
        if (data.status == true) {
            notify('success', data.message, 'Forgot Transaction Pin');
            setTimeout(function() {
                location.reload();
    ...
    // END: forgot transaction password
    ...
    $(document).on('change', '#otp_all', function(event) {
        ...
        $.ajax({
            url: '/user/otp_verification_submit/otp_all/' + check_value,
            method: 'POST',
            dataType: 'json',
            cache: false,
            contentType: false,
    ...
    $(document).on('change', '#otp_deposit', function(event) {
        ...
        $.ajax({
            url: '/user/otp_verification_submit/otp_deposit/' + check_value,
            method: 'POST',
            dataType: 'json',
            cache: false,
            contentType: false,
    ...
    $(document).on('change', '#otp_withdraw', function(event) {
        ...
        $.ajax({
            url: '/user/otp_verification_submit/otp_withdraw/' + check_value,
            method: 'POST',
            dataType: 'json',
            cache: false,
            contentType: false,
    ...
    $(document).on('change', '#otp_transfer', function(event) {
        ...
        $.ajax({
            url: '/user/otp_verification_submit/otp_transfer/' + check_value,
            method: 'POST',
            dataType: 'json',
            cache: false,
            contentType: false,
    ...
    $(document).on('change', '#otp_live_account', function(event) {
        ...
        $.ajax({
            url: '/user/otp_verification_submit/otp_live_account/' + check_value,
            method: 'POST',
            dataType: 'json',
            cache: false,
            contentType: false,
    ...
    function password_reset_call_back(data) {
        if (data.status) {
    ...
    // mail auth
    $(document).on('click', '#forgot_transaction_pin', function(event) {
        $('#forgot_transaction_pin').prop('disabled', true);
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
        ...
        $.ajax({
            url: '/user/user-admin/settings/forgot-transaction-pin',
            method: 'POST',
            dataType: 'json',
            cache: false,
            contentType: false,
            ...
            success: function(data) {
                ...
                $('#forgot_transaction_pin').prop('disabled', false);
            }
        });
    });
</script>
