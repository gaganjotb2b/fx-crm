                ...
                <form id="filter-form" class="dt_adv_search" method="POST">
                    ...
                    <div class="row gy-2 mb-md-1 my-3">
                        ...
                        <div class="col-lg-4 col-md-6 mb-1 p-1">
                            <input type="text" class="form-control" name="investor_info" id="investor_email" placeholder="PAMM email/name/account">
                        </div>
                        <div class="col-lg-4 col-md-6 mb-1 p-1">
...
<script>
    var investment_report = $("#deposit_report_datatable").DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "/user/pamm-report/income-report/data",
            "data": function(d) {
