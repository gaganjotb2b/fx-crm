                ...
                <div class="card-body">
                    ...
                    <form id="filter-form" class="dt_adv_search" method="POST">
                        <div class="row g-1 mb-md-1 my-3">
                            <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Search By Method">
                                <select class="form-select choice-material" name="type" id="type">
                                    <optgroup label="Select Method">
                                        <option value="">{{ __('page.all') }}</option>
                                        <option value="send">{{ __('ad-reports.Send') }}</option>
                                        <option value="receive">{{ __('ad-reports.Receive') }}</option>
                                    </optgroup>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <input type="text" class="form-control dt-input dt-full-name" data-column="1"
                                    name="txnID" id="txnID" placeholder="{{ __('page.transaction-id') }}"
                                    data-column-index="0" />
                            </div>
                            <div class="col-lg-4 col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Search By Minimum Or Maximum">
                                <div class="col-12">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="col-12">
                                    <div class="col-12 input-rang-group" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Search By Fund Transfer Date">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-flush datatables-ajax w-100" id="external_report_datatable">
                            ...
                            <tfoot>
                                <tr>
                                    <th colspan="6" style="text-align: right;" class="details-control"
...
@section('page-js')
    ...
    <script type="text/javascript" language="javascript"
        src="{{ asset('admin-assets/app-assets/js/scripts/pages/server-side-button-action.js') }}"></script>
    <script type="text/javascript" language="javascript"
        src="{{ asset('admin-assets/app-assets/js/scripts/pages/datatable-functions.js') }}"></script>
    <script>
        // $(document).ready(function() {
        //     var datatable = dt_fetch_data(
        //         '/user/reports/external-fund-transfer-report?op=data_table',
        //         [{
        //                 "data": "sender_email"
        //             },
        //             {
        ...
        //             },
        //         ],
        //         true, false, true, [0, 1, 2, 3, 4, 5, 6, ], 2, true, true
        //     )
        // });
        var deposit_report = $("#external_report_datatable").fetch_data({
            url: '/user/reports/external-fund-transfer-report?op=data_table',
            csv_export: true,
