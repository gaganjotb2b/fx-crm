            ...
            <div class="al-minHei">
                ...
                <div class="card blur shadow-blur " id="chet-details">
                    ...
                    <div class="card-footer d-block">
                        <form class="align-items-center position-relative" action="{{ route('user.support.support-send-reply') }}" id="form-sent-replay" method="POST" enctype="multipart/form-data">
                            @csrf
                ...
                <div class="card blur shadow-blur" id="add_new_ticket">
                            ...
                            <div class="col-md-10">
                                <div class="d-flex align-items-center">
                                    <div class="ms-3 d-flex">
                                        ...
                                        <h6 class="mb-0 d-block "> {{ __('support-ticket.compose_your_ticket') }}</h6>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('user.support.create-ticket') }}" id="form-create-ticket" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-8">
...
<script>
    ...
    function showSupportData(filterData) {
        ...
        var dataList = data_list.data_list({
            serverSide: true,
            url: '/user/support/support-ticket-get',
            listPerPage: 5,
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#data-list li', function() {
            ...
            $.ajax({
                url: '/user/support/support-ticket-reply?id=' + dataId,
                dataType: 'json',
                method: 'post',
        ...
        $(document).on('click', '#al_delete_itmes', function() {
            ...
            $.ajax({
                url: '/user/support/support-ticket-delete',
                dataType: 'json',
                data: data,
                method: 'POST',
                success: function(data) {
    ...
    function getServerReplay() {
        ...
        $.ajax({
            url: '/user/support/get-server-replay',
            dataType: 'json',
            method: 'POST',
            success: function(data) {
                if (data.status) {
