...
@section('title', 'Account to wallet transfer')
@section('page-css')
...
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12 text-center">
            <h3 class="mt-5">{{ __('page.account-to-wallet-transfer') }}</h3>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <div class="multisteps-form__form">
                            <form class="form-demo" action="{{ route('user.transfer.account-to-wallet-transfer-form') }}" method="post" id="atw-transfer-form">
                                <!--single form panel-->
                                    ...
                                    <div class="multisteps-form__content">
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-12 col-sm-6 mx-auto mt-4 mt-sm-0 text-start">
                                                <!-- check account to wallet permited -->
                                                ...
                                                <div class="col-8 mx-auto">
                                                    <div class="alert alert-warning" role="alert">
                                                        <strong>Warning!</strong> You are not permited to account to wallet transfer! Please contact with <strong> {{config('app.name')}} </strong> Support.
                                                    </div>
                                                </div>
                                                @endif
                                            </div>
                                        ...
                                        <div class="button-row d-flex mt-4">
                                            ...
                                            <div class="col-6 mx-auto">
                                                ...
                                                @if(\App\Services\Trader\FinanceService::check_op('atw'))
                                                <button type="button" data-label="Submit Request" id="btn-submit-request" data-btnid="btn-submit-request" data-callback="atw_transfer_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="atw-transfer-form" data-el="fg" onclick="_run(this)" class="btn bg-gradient-primary ms-auto mb-3 mt-4 float-end" data-submit_wait="{{ submit_wait('atw-transfer', 60) }}" {{ $disable }} style="width:200px">{{ __('page.submit-request') }}</button>
                                                @endif
                                            </div>
                                            @if(!\App\Services\OtpService::has_otp('transfer',auth()->user()->id))
                                ...
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
                                            ...
                                            <div class="col-12 col-sm-6 mx-auto mt-4 mt-sm-0 text-start">
                                                <div class=" text-center row gx-2 gx-sm-3 custom-otp-boxs border p-6 rounded">
                                                    ...
                                                    <span class="text-muted text-sm">{{ __('page.haven\'t-received-it?') }}
                                                        ...
                                                        <button type="button" data-label="Resend Code" id="btn-resend-code" data-btnid="btn-resend-code" data-callback="atw_transfer_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="atw-transfer-form" data-el="fg" onclick="_run(this)" class="btn mb-0 text-capitalize btn-submit-request visually-hidden" data-op="step-2" style="width:200px">{{ __('page.resend-code') }}</button>.</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="button-row d-flex mt-4 col-12">
                                            <div class="col-4"></div>
                                            <div class="col-6 mx-auto">
                                                <button type="button" data-label="Submit Request" id="btn-submit-request-final" data-btnid="btn-submit-request-final" data-callback="atw_transfer_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="atw-transfer-form" data-el="fg" onclick="_run(this)" class="btn bg-gradient-primary ms-auto ms-3 float-end" style="width:200px">{{ __('page.submit-request') }}</button>
                                ...
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
                                    <div class="row text-center">
                                        <div class="col-10 mx-auto">
                                            ...
                                            <p>{{ __('page.your-wallet-to-trading-account-trasaction-status-here-you-can-find-olny-your-last-wallet-to-transaction-status-you-also-find-your-all-transaction-report-in-reports-area') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="multisteps-form__content">
...
<script>
    ...
    $("#atw-transfer-form").trigger("reset");
    $("#op").val('step-1');
    ...
    function atw_transfer_call_back(data) {
        if (data.status == true) {
            notify('success', data.message, 'Account to Wallet Balance Transfer');
            ...
            $.validator("atw-transfer-form", data.errors);
        }
        if (data.status == false) {
            $.validator("atw-transfer-form", data.errors);
            notify('error', data.message, 'Account to wallet balance transfer');
        }
        // validation status
