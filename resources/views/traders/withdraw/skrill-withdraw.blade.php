...
<div class="container-fluid py-4">
    <div class="row custom-height-con">
        <div class="col-12 text-center">
            <h3 class="mt-5">{{ __('ad-reports.skrill') }} {{ __('page.withdraw') }}</h3>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <div class="multisteps-form__form bg-custom-dark-for rounded-3">
                            <form class="form-demo" action="{{ route('user.withdraw.skrill-withdraw') }}" method="post" id="skrill-withdraw-form">
                                <!--single form panel-->
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                                    <div class="row text-center">
                                        ...
                                        <div class="col-10 mx-auto">
                                            ...
                                            <p>{{ __("page.let us know your name and email address using an address you don't mind other users contacting you at") }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="multisteps-form__content">
                                        <div class="row mt-3">
                                            <div class="col-12 col-sm-4">
                                                <div class="avatar avatar-xxl position-relative">
                                                    <img id="platform-logo" src="{{ asset('trader-assets/assets/img/logos/currency-logo/skirll.png') }}" class="border-radius-md img-thumbnail" alt="team-2">
                                                </div>
                                            </div>
                                            <!-- first step form -->
                                            <div class="col-12 col-sm-6 mx-auto mt-4 mt-sm-0 text-start">
                                                ...
                                                <div class="form-group">
                                                    <label for="skrill-account-name">{{ __('ad-reports.skrill') }}
                                                        {{ __('page.account') }} {{ __('page.name') }}</label>
                                                    <input type="text" name="skrill_account_name" id="skrill-account-name" placeholder="Skrill Account Name" class="form-control form-control-alternative" />
                                                </div>
                                                <div class="form-group">
                                                    <label for="skrill-account-email">{{ __('ad-reports.skrill') }}
                                                        {{ __('page.account') }} {{ __('page.email') }}</label>
                                                    <input type="email" name="skrill_account_email" id="skrill-account-email" placeholder="Skrill account email" class="form-control form-control-alternative" />
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <div class="button-row d-flex mt-4">
                                            @php
                                            $disable = '';
                                            $has_multi_submit = has_multi_submit('skrill-withdraw', 60);
                                            if ($has_multi_submit) {
                                            $disable = 'disabled';
                                            }
                                            @endphp
                                            ...
                                            <div class="col-6 mx-auto">
                                                ...
                                                <!-- check kyc required -->
                                                @if(\App\Services\AllFunctionService::kyc_required((auth()->user()->id),'withdraw') == false )
                                                <button type="button" data-label="Next" id="btn-submit-request" data-btnid="btn-submit-request" data-callback="skrill_withdraw_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="skrill-withdraw-form" data-el="fg" onclick="_run(this)" class="btn bg-gradient-primary ms-auto mb-3 float-end mt-4" style="width: 200px;">{{ __('page.next') }}</button>
                                                @endif
                                                @endif
                                            </div>
                                ...
                                <div class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
                                    <div class="row text-center">
                                        <div class="col-10 mx-auto">
                                            ...
                                            <p>{{ __('page.Your_skrill_account_trasaction_status_here') }}</p>
                                        </div>
                                    </div>
                                    <div class="multisteps-form__content">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6 mx-auto mt-4 mt-sm-0 text-start">
                                                <div class=" text-center row gx-2 gx-sm-3 custom-otp-boxs border p-6 rounded">
                                                    ...
                                                    <span class="text-muted text-sm">{{ __('page.have\'t_recive') }}?
                                                        ...
                                                        <button type="button" data-label="Resend Code" id="btn-resend-code" data-btnid="btn-resend-code" data-callback="skrill_withdraw_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="skrill-withdraw-form" data-el="fg" onclick="_run(this)" class="btn mb-0 text-capitalize btn-submit-request visually-hidden" data-op="step-2" style="width:200px">{{ __('page.resend_code') }}</button>.</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="button-row d-flex mt-4 col-12">
                                            <div class="col-4"></div>
                                            <div class="col-6 mx-auto">
                                                <button type="button" data-label="Submit Request" id="btn-submit-request-final" data-btnid="btn-submit-request-final" data-callback="skrill_withdraw_call_back" data-loading="<i class='fa-spin fas fa-circle-notch'></i>" data-form="skrill-withdraw-form" data-el="fg" onclick="_run(this)" class="btn bg-gradient-primary ms-auto ms-3 float-end" style="width:200px">{{ __('page.submit-request') }}</button>
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th id="last-txn-id">
                                                                {{ $last_transaction ? ucwords($last_transaction->transaction_type) : '---' }}
                                                            </th>
                                                        </tr>
                                                        <tr>
...
<script>
    ...
    $("#skrill-withdraw-form").trigger('reset');
    $("#op").val('step-1');
    // resending otp
    ...
    function skrill_withdraw_call_back(data) {
        if (data.status == true) {
            ...
            $.validator("skrill-withdraw-form", data.errors);
        }
