...
<?php $__env->startSection('title','System Login'); ?>
    ...
    <div class="auth-inner row m-0">
        ...
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                <!-- /Brand logo-->
                <h2 class="card-title fw-bold mb-1">Welcome to <?php echo e(strtoupper(config('app.name'))); ?>! </h2>
                <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>
                <div id="alert-message" class="alert alert-danger p-1 d-none" role="alert">
                </div>

                <form id="system-login-form" class="auth-login-form mt-2" action="<?php echo e(route('system.login.action')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-1">
...
<!-- <script src="<?php echo e(asset('admin-assets/app-assets/js/scripts/pages/system-login.js')); ?>"></script> -->
<!-- END: Page JS-->
<script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\code\fxcrm\fx\crm-new-laravel\resources\views/auth/systems/login.blade.php ENDPATH**/ ?>