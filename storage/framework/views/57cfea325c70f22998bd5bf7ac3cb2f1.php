...
<?php $__env->startSection('title','Admin module Setting'); ?>
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Admin <?php echo e(__('page.settings')); ?></h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Admin <?php echo e(__('page.settings')); ?></li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header border-bottom mb-0">
                            <div class="card my-0 py-0 w-100">
                                <div class="card-body my-0 py-0 d-flex justify-content-between">
                                    <h4 class="card-title float-start d-flex"><?php echo e(__('page.admin')); ?> <?php echo e(__('page.settings')); ?></h4>
...
<script src="<?php echo e(asset('common-js/admin-settings.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<!-- BEGIN: page JS -->
<?php echo $__env->make('layouts.system-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\code\fxcrm\fx\crm-new-laravel\resources\views/systems/configurations/system-module.blade.php ENDPATH**/ ?>