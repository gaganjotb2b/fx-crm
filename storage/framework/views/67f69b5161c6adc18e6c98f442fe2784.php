...
<?php $__env->startSection('title','Trader Login'); ?>
...
<div class="row">
    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
        ...
        <div class="card card-plain mt-5">
            ...
            <div class="card-body">
                <!-- login form -->
                <form action="<?php echo e(route('trader.login.action')); ?>" method="POST" enctype="multipart/form-data" role="form" class="text-start login-form-body" id="trader-login-form">
                    <?php echo csrf_field(); ?>
                    <label>Email</label>
                    <div class="mb-3">
                        <input type="email" name="email" class="form-control email" placeholder="Email" aria-label="Email" value="<?php echo e(Cookie::get('remember_email')); ?>" required>
                    </div>
                    <label>Password</label>
                    <div class="mb-3">
                        <input type="password" name="password" class="form-control password" placeholder="Password" aria-label="Password" value="<?php echo e(Cookie::get('remember_password')); ?>" required>
                    </div>
                ...
                <!-- mail verification -->
                <form action="<?php echo e(route('trader.login.action')); ?>" method="POST" enctype="multipart/form-data" role="form" class="text-start mail-verification-form-body d-none" id="trader-login-mail-verification-form">
                    <?php echo csrf_field(); ?>
                ...
                <!-- google verification -->
                <form action="<?php echo e(route('trader.login.action')); ?>" method="POST" enctype="multipart/form-data" role="form" class="text-start google-verification-form-body d-none" id="trader-login-google-verification-form">
                    <?php echo csrf_field(); ?>
                    <div class="row gx-2 gx-sm-3 mt-5">
                        <div class="col">
                            <div class="form-group">
            ...
            <div class="card-footer text-center pt-0 px-lg-2 px-1 login-form-body">
                <p class="mb-0 text-sm mx-auto">
                    ...
                    <a href="<?php echo e(route('trader.registration')); ?>" class="text-info text-gradient font-weight-bold">Sign up</a>
                </p>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
            <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style='background-image:unset; background-color: var(--custom-primary);'>
                <a class="brand-logo p-2 bg-gradient-light rounded-2 w-100" href="<?php echo e(route('trader.login')); ?>">
                    <img src="<?php echo e(get_user_logo()); ?>" height="40" alt="<?php echo e(config('app.name')); ?>">
                </a>
                <div class="__al_shape_text">
                    <div class="alert " role="alert">
                        <h4 class="alert-heading" style="color:#fff;">Start Trading with <?php echo e(config('app.name')); ?>. Trade and invest in Trading
                            platforms,
                            Buy and sells</h4>
                        <div class="alert-body" style="color:#fff;">
                            Login into <?php echo e(config('app.name')); ?>, the trusted client portal traders for over few years. Trade on
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.trader-auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\code\fxcrm\fx\crm-new-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>