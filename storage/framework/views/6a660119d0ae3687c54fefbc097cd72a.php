...
<?php $__env->startSection('title','Trader Setting'); ?>
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0"><?php echo e(__('page.trader')); ?> <?php echo e(__('page.settings')); ?></h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><?php echo e(__('page.trader')); ?> <?php echo e(__('page.settings')); ?></li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <div class="content-body">
            <div class="row">
                ...
                <div class="col-12 col-sm-7">
                    <?php if(Auth::user()->hasDirectPermission('edit trader setting')): ?>
                    <div class="card">
                        <div class="card-header border-bottom mb-0">
                            <div class="card my-0 py-0 w-100">
                                <div class="card-body my-0 py-0 d-flex justify-content-between">
                                    <h4 class="card-title float-start d-flex"><?php echo e(__('page.trader')); ?> <?php echo e(__('page.settings')); ?></h4>
                                    <?php if(system_disable('trader')): ?>
                                    <div>
                        ...
                        <div class="card mt-0 mb-0">
                            <div class="col-12">
                                <form action="<?php echo e(route('admin.settings.trader_setting.update')); ?>" class="mt-2 pt-50" method="POST" enctype="multipart/form-data" id="trader-setting-update-form">
                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-12 col-sm-7">
                        <div class="card">
                            <div class="card-body">
                                <?php echo $__env->make('errors.permission', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
...
<!-- <div class="enable-backdrop">
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBackdrop" aria-labelledby="offcanvasBackdropLabel">
        ...
        <div class="offcanvas-body my-auto mx-0 flex-grow-0">
            <form action="<?php echo e(route('admin.settings.trader_setting.add')); ?>" method="post" id="trader-setting-add-form">
                <?php echo csrf_field(); ?>
...
<script src="<?php echo e(asset('admin-assets/app-assets/js/scripts/forms/form-select2.js')); ?>"></script>
<script src="<?php echo e(asset('common-js/trader-settings.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<!-- BEGIN: page JS -->
<?php echo $__env->make('layouts.system-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\code\fxcrm\fx\crm-new-laravel\resources\views/systems/configurations/trader-settings.blade.php ENDPATH**/ ?>