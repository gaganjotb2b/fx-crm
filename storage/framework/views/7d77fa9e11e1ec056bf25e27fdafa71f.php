...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="<?php echo e(asset('admin-assets/app-assets/images/pages/eCommerce/1.png')); ?>"
                                    alt="donuts" width="62">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="<?php echo e(asset('admin-assets/app-assets/images/pages/eCommerce/7.png')); ?>"
                                    alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="<?php echo e(asset('admin-assets/app-assets/images/pages/eCommerce/2.png')); ?>"
                                    alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="<?php echo e(asset('admin-assets/app-assets/images/pages/eCommerce/3.png')); ?>"
                                    alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                    src="<?php echo e(asset('admin-assets/app-assets/images/pages/eCommerce/5.png')); ?>"
                                    alt="donuts" width="62">
                                <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                        data-feather="x"></i>
                                    <div class="media-heading">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="#">
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img src="<?php echo e(asset(avatar())); ?>" alt="avatar"
                                ...
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img
                                                src="<?php echo e(asset('admin-assets/app-assets/images/portrait/small/avatar-s-3.jpg')); ?>"
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#"
                        ...
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">IT Corner</span><span
                                ...
                                src="<?php echo e(asset(avatar())); ?>" alt="avatar" height="40" width="40"><span
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto" style="width:76%">
                    <a class="navbar-brand" href="<?php echo e(asset('html/ltr/vertical-menu-template/index.html')); ?>"><span
                            class="brand-logo">
                            <img class="img img-fluid" src="<?php echo e(get_admin_logo()); ?>" alt="<?php echo e(config('app.name')); ?>">
                            <!-- <h2 class="brand-text"><?php echo e(strtoupper(config('app.name'))); ?></h2> -->
                    </a>
                </li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <!-- system dashboard -->
                <li class="<?php echo e(Request::is('system/dashboard') ? 'active' : ''); ?>" id="mainMenuLi">
                    <a class="d-flex align-items-center" href="<?php echo e(route('system.dashboard')); ?>">
                        <i data-feather="home"></i>
                        <span class="menu-item text-truncate" data-i18n="Configuration">Dashaboard</span>
                    </a>
                </li>
                <!-- Banks -->
                <li class=" nav-item <?php echo e(Request::is('/system/banks*') ? 'open' : ''); ?>">
                    ...
                    <ul class="menu-content">
                        <li class="<?php echo e(Request::is('/system/banks/online-bank-list') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('systems.online-bank-list')); ?>">
                ...
                <!-- crypto currency -->
                <li class=" nav-item <?php echo e(Request::is('/system/crypto/*') ? 'open' : ''); ?>">
                    <a class="d-flex align-items-center" href="#">
                        <i data-feather='box'></i>
                    ...
                    <!-- activities log reports -->
                    <ul class="menu-content">
                        <li class="<?php echo e(Request::is('/system/crypto/crypto-currency') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('system.crypto-currency')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Activity log">Crypto currency</span>
                            </a>
                        </li>
                        <li class="<?php echo e(Request::is('/system/m2pay-config') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('system.m2pay-config')); ?>">
                                <i data-feather="circle"></i>
                ...
                <!-- configuration -->
                <li class=" nav-item <?php echo e(Request::is('system/configurations/*') ? 'open' : ''); ?>"
                    ...
                    <ul class="menu-content">
                        <!-- api configuration -->
                        <li class="<?php echo e(Request::is('system/configurations/api_configuration') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="api_configuration"
                                href="<?php echo e(route('system.configurations.api_configuration')); ?>">
                                <i data-feather="circle"></i>
                        ...
                        <li
                            class="<?php echo e(Request::is('/system/configurations/ib-commission-structure-replace') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center"
                                href="<?php echo e(route('system.ib-commission-structure-replace')); ?>">
                                <i data-feather="circle"></i>
                        ...
                        <!-- company setup -->
                        <li class="<?php echo e(Request::is('system/configurations/company_setup') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="company_setup"
                                href="<?php echo e(route('system.configurations.company_setup')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Company Setup">Company Setup</span>
                            </a>
                        </li>
                        <!-- finance -->
                        <li class="<?php echo e(Request::is('system/configurations/finance_setting') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="finance_setting"
                                href="<?php echo e(route('system.configurations.finance_setting')); ?>">
                                <i data-feather="circle"></i>
                        ...
                        <!-- smtp setup -->
                        <li class="<?php echo e(Request::is('system/configurations/smtp_setup') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="smtp_setup"
                                href="<?php echo e(route('system.configurations.smtp_setup')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="SMTP Setup">SMTP Setup</span>
                            </a>
                        </li>
                        <!-- footer link setup -->
                        <li class="<?php echo e(Request::is('system/configurations/footer_link') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="footer_link"
                                href="<?php echo e(route('system.configurations.footer_link')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Footer Links">Footer Links</span>
                            </a>
                        </li>
                        <!-- software -->
                        <li class="<?php echo e(Request::is('system/configurations/software_setting') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="software_setting"
                                href="<?php echo e(route('system.configurations.software_setting')); ?>">
                                <i data-feather="circle"></i>
                        ...
                        <!-- theme setup -->
                        <li class="<?php echo e(Request::is('system/configurations/theme_setup') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="theme_setup"
                                href="<?php echo e(route('system.configurations.theme_setup')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Theme Setup">Theme Setup</span>
                            </a>
                        </li>
                        <!-- pamm settings -->
                        <li class="<?php echo e(Request::is('system/pamm-setting') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="" href="<?php echo e(route('system.pamm')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Theme Setup">PAMM Settings</span>
                            </a>
                        </li>
                        <!-- company links -->
                        <li class="<?php echo e(Request::is('system/company-links') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id=""
                                href="<?php echo e(route('system.company_links')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Theme Setup">Company Links</span>
                            </a>
                        </li>
                        <!-- admin settings -->
                        <li class="<?php echo e(Request::is('system/admin-settings') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id=""
                                href="<?php echo e(route('system.admin-settings.by-system-admin')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Theme Setup">Admin rights</span>
                            </a>
                        </li>
                        <!-- trading account configurations-->
                        <li class="<?php echo e(Request::is('system/admin-account/configuration') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id=""
                                href="<?php echo e(route('system.admin-account.configuration')); ?>">
                                <i data-feather="circle"></i>
                ...
                <!-- migrtion -->
                <li class=" nav-item <?php echo e(Request::is('system/migration/user-migration/*') ? 'open' : ''); ?>">
                    <a class="d-flex align-items-center" href="#">
                    ...
                    <!-- user migration -->
                    <ul class="menu-content">
                        <li class="<?php echo e(Request::is('system/migration/user-migration/view') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('system.user-migration-view')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="User Migration">User Migration</span>
                            </a>
                        </li>
                        <!-- name email migration -->
                        <li class="<?php echo e(Request::is('system/migration/user-migration/name-email') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('system.name-email-migration')); ?>">
                                <i data-feather="circle"></i>
                        ...
                        <li
                            class="<?php echo e(Request::is('system/migration/user-migration/manager-asigne') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center"
                                href="<?php echo e(route('system.manager-asigne-migration')); ?>">
                                <i data-feather="circle"></i>
                        ...
                        <!-- deposit migration -->
                        <li class="<?php echo e(Request::is('system/migration/deposit-migration/view') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('system.deposit-migration-view')); ?>">
                                <i data-feather="circle"></i>
                        ...
                        <!-- withdraw migration -->
                        <li class="<?php echo e(Request::is('system/migration/withdraw-migration/view') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center"
                                href="<?php echo e(route('system.withdraw-migration-view')); ?>">
                                <i data-feather="circle"></i>
                        ...
                        <!-- ib to sub ib -->
                        <li class="<?php echo e(Request::is('system/migration/user-migration/ib-reference') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center"
                                href="<?php echo e(route('system.migration.ib-reference')); ?>">
                                <i data-feather="circle"></i>
                        ...
                        <!-- ib to trader -->
                        <li
                            class="<?php echo e(Request::is('system/migration/user-migration/clients-reference') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center"
                                href="<?php echo e(route('system.migration.clients-reference')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Activity log">IB to Clients</span>
                            </a>
                        </li>
                        <!-- direct ib convert -->
                        <li class="<?php echo e(Request::is('system/migration/user-migration/convert-ib') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('system.migration.convert-ib')); ?>">
                                <i data-feather="circle"></i>
                ...
                <!-- choose mailer -->
                <li class=" nav-item <?php echo e(Request::is('/system/mailer/*') ? 'open' : ''); ?>">
                    <a class="d-flex align-items-center" href="#">
                    ...
                    <!-- activities log reports -->
                    <ul class="menu-content">
                        <li class="<?php echo e(Request::is('/system/mailer/choose-template') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center"
                                href="<?php echo e(route('system.mailer.choose-template')); ?>">
                                <i data-feather="circle"></i>
                ...
                <!-- retports -->
                <li class=" nav-item <?php echo e(Request::is('system/report/*') ? 'open' : ''); ?>">
                    <a class="d-flex align-items-center" href="#">
                    ...
                    <!-- activities log reports -->
                    <ul class="menu-content">
                        <li class="<?php echo e(Request::is('system/reports/activity_log') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('system.reports.activity_log')); ?>">
                                <i data-feather="circle"></i>
                ...
                <li class=" nav-item <?php echo e(Request::is('system/report/*') ? 'open' : ''); ?>">
                    ...
                    <ul class="menu-content">
                        <!-- trader sttings -->
                        <li class="<?php echo e(Request::is('system/trader-settings') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="theme_setup"
                                href="<?php echo e(route('system.trader-settings.by-system-admin')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Theme Setup">Trader Module</span>
                            </a>
                        </li>
                        <!-- ib settins -->
                        <li class="<?php echo e(Request::is('system/ib-settings') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="theme_setup"
                                href="<?php echo e(route('system.ib-settings.by-system-admin')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Theme Setup">IB Module</span>
                            </a>
                        </li>
                        <!-- admin module -->
                        <li class="<?php echo e(Request::is('system/system-module') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="theme_setup"
                                href="<?php echo e(route('system.system-modules')); ?>">
                                <i data-feather="circle"></i>
                ...
                <!-- Payments setting -->
                <li class="nav-item <?php echo e(Request::is('system/payments-settings/*') ? 'open' : ''); ?>">
                    ...
                    <ul class="menu-content">
                        <!-- help2pay sttings -->
                        <li class="<?php echo e(Request::is('system/payments-settings/help2pay') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" id="payments_setting"
                                href="<?php echo e(route('system.help2pay-settings')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Payments Settings">Help2pay</span>
                            </a>
                        </li>
                        <!-- praxis settins -->
                        <li class="<?php echo e(Request::is('system/payments-settings/praxis') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('system.praxis-settings')); ?>">
                                <i data-feather="circle"></i>
                                <span class="menu-item text-truncate" data-i18n="Payments Settings">Praxis</span>
                            </a>
                        </li>
                        <!-- B2B settins -->
                        <li class="<?php echo e(Request::is('system/payments-settings/b2b') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('system.b2b-settings')); ?>">
                                <i data-feather="circle"></i>
                ...
                <hr>
                <!-- mobile application -->
                <li class=" nav-item <?php echo e(Request::is('/system/mobile-application/*') ? 'open' : ''); ?>">
                    <a class="d-flex align-items-center" href="#">
                    ...
                    <!-- activities log reports -->
                    <ul class="menu-content">
                        <li class="<?php echo e(Request::is('/system/mobile-application/logo-controll') ? 'active' : ''); ?>">
                            <a class="d-flex align-items-center" href="<?php echo e(route('mobile.app.logo_controll')); ?>">
                                <i data-feather="circle"></i>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span
                class="float-md-start d-block d-md-inline-block mt-25"><?php echo e(get_copyright()); ?></span><span
...
<?php /**PATH I:\code\fxcrm\fx\crm-new-laravel\resources\views/layouts/system-layout.blade.php ENDPATH**/ ?>