<!DOCTYPE html>
<html class="loading <?php echo e(get_admin_theme()); ?>" lang="en" data-layout="dark-layout" data-textdirection="ltr">
...
<head>
    ...
    <title>Not-authorized - <?php echo e(config('app.name')); ?></title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="index.html">
                        <img class="img img-fluid" src="<?php echo e(get_user_logo()); ?>" alt="<?php echo e(config('app.name')); ?>" style="width: 200px;">
                        <!-- <h2 class="brand-text text-primary ms-1"><?php echo e(config('app.name')); ?></h2> -->
                    </a>
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-2">
                                ...
                                serves.
                            </p><a class="btn btn-primary mb-1 btn-sm-block" href="<?php echo e(url()->previous()); ?>">Back to Previous</a><img class="img-fluid" src="<?php echo e(asset('admin-assets/app-assets/images/pages/not-authorized-dark.svg')); ?>" alt="Not authorized page" />
                        </div>
                    </div>
                </div>
                <!-- / Not authorized-->
...
</html><?php /**PATH C:\Users\b2b\Downloads\crm\resources\views/errors/not-authorize.blade.php ENDPATH**/ ?>