    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
            ...
            <section id="dashboard-ecommerce">
                <!-- setting row -->
                <div class="row">
                    <!-- Remaining commission stup -->
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body d-flex align-items-center justify-content-between">
                                <div>
                                    <h6 class="fw-bolder mb-75">
                                        <label class="form-check-label mb-50" for="remaining-com">Remaining commission setup</label>
                                    </h6>
                                    <div class="d-flex flex-column">
                                        <div class="form-check form-check-success form-switch">
                                            <input type="checkbox" checked class="form-check-input" id="remaining-com" />
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo e(asset('admin-assets/app-assets/images/icons/toolbox.svg')); ?>" alt="Toolbar svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo e(asset('admin-assets/app-assets/images/icons/parachute.svg')); ?>" alt="Parachute svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo e(asset('admin-assets/app-assets/images/icons/brush.svg')); ?>" alt="Brush svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo e(asset('admin-assets/app-assets/images/icons/star.svg')); ?>" alt="Star svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo e(asset('admin-assets/app-assets/images/icons/book.svg')); ?>" alt="Book svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo e(asset('admin-assets/app-assets/images/icons/rocket.svg')); ?>" alt="Rocket svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="<?php echo e(asset('admin-assets/app-assets/images/icons/speaker.svg')); ?>" alt="Speaker svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="card card-developer-meetup">
                            <div class="meetup-img-wrapper rounded-top text-center">
                                <img src="<?php echo e(asset('admin-assets/app-assets/images/illustration/email.svg')); ?>" alt="Meeting Pic" height="170" />
                            </div>
                            <div class="card-body">
                                ...
                                <div class="avatar-group">
                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Billy Hopkins" class="avatar pull-up">
                                        <img src="<?php echo e(asset('admin-assets/app-assets/images/portrait/small/avatar-s-9.jpg')); ?>" alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Amy Carson" class="avatar pull-up">
                                        <img src="<?php echo e(asset('admin-assets/app-assets/images/portrait/small/avatar-s-6.jpg')); ?>" alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Brandon Miles" class="avatar pull-up">
                                        <img src="<?php echo e(asset('admin-assets/app-assets/images/portrait/small/avatar-s-8.jpg')); ?>" alt="Avatar" width="33" height="33" />
                                    </div>
                                    <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Daisy Weber" class="avatar pull-up">
                                        <img src="<?php echo e(asset('admin-assets/app-assets/images/portrait/small/avatar-s-20.jpg')); ?>" alt="Avatar" width="33" height="33" />
                                    </div>
                        ...
                        <div class="card card-browser-states">
                            ...
                            <div class="card-body">
                                <div class="browser-states">
                                    <div class="d-flex">
                                        <img src="<?php echo e(asset('admin-assets/app-assets/images/icons/google-chrome.png')); ?>" class="rounded me-1" height="30" alt="Google Chrome" />
...
<script>
    $(document).on('change', "#remaining-com", function() {
        let option = '';
        if ($(this).is(":checked")) {
             option = 'on';
        ...
        $(this).confirm2({
            title: 'Remaining commission setup',
            message: 'Are you confirm to update this setup?',
            method: 'POST',
            request_url: '/system/settings/remaining-commission-setup',
            data: {
                option: option
            }
        }, function(data) {
            if (data.status == true) {
                notify('success', data.message, 'Remaining commission setup');
            } else {
                notify('error', data.message, 'Remaining commission setup');
            }
        });
    })
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.system-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\code\fxcrm\fx\crm-new-laravel\resources\views/systems/dashboard.blade.php ENDPATH**/ ?>