...
<div class="auth-wrapper auth-cover">
    <div class="auth-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="<?php echo e(asset('admin-assets/app-assets/images/pages/login-v2.svg')); ?>" alt="Login V2" /></div>
        </div>
        <!-- /Left Text-->
        <!-- Login-->
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                <!-- Brand logo-->
                <a class="brand-logo pb-4 w-auto" href="<?php echo e(route('admin.login')); ?>">
                    <img src="<?php echo e(get_admin_logo()); ?>" height="40" alt="<?php echo e(config('app.name')); ?>">
                </a>
                <!-- /Brand logo-->
                <!-- start admin login header -->
                <h2 class="card-title fw-bold mb-1 admin-login-form">Welcome to <?php echo e(strtoupper(config('app.name'))); ?>! </h2>
                ...
                <form class="auth-login-form mt-2 admin-login-form" action="<?php echo e(route('admin.login.action')); ?>" method="POST" enctype="multipart/form-data" id="admin-login-form">
                    <?php echo csrf_field(); ?>
                    <div class="mb-1">
                    ...
                    <div class="mb-1">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="remember-me"> Remember Me</label><a class="text-danger float-end forgot_password" href="#"><u><?php echo e(__('page.forgot_password')); ?>?</u></a>
                        </div>
                    </div>
                ...
                <form class="mt-2 mail-verification-form d-none" action="<?php echo e(route('admin.login.action')); ?>" method="POST" id="mail-verification-form">
                    <?php echo csrf_field(); ?>
                ...
                <form class="mt-2 mb-3 google-verification-form d-none" action="<?php echo e(route('admin.login.action')); ?>" method="POST" id="google-verification-form">
                    <?php echo csrf_field(); ?>
                    <h6>Type your 6 digit security code</h6>
                ...
                <form action="<?php echo e(route('user.forgot_password')); ?>" method="POST" enctype="multipart/form-data" role="form" class="text-start admin-forgot-password-form d-none" id="trader-forgot-password-form">
                    <?php echo csrf_field(); ?>
                    <label>Email</label>
                    <div class="mb-3">
                ...
                <form action="<?php echo e(route('user.forgot_password')); ?>" method="POST" enctype="multipart/form-data" role="form" class="text-start admin-forgot-password-verification-form d-none" id="trader-forgot-password-verification-form">
                    <?php echo csrf_field(); ?>
                    <div class="auth-input-wrapper d-flex align-items-center justify-content-between pb-2">
                ...
                <form action="<?php echo e(route('user.forgot_password')); ?>" method="POST" enctype="multipart/form-data" role="form" class="text-start admin-create-new-password-form d-none" id="trader-create-new-password-form">
                    <?php echo csrf_field(); ?>
                ...
                <p class="text-center mt-2 admin-login-form"><span>New on our platform?</span><a href="<?php echo e(route('admin.registration')); ?>"><span>&nbsp;Create an account</span></a></p>
...
<!-- END: Page JS-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin-auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH I:\code\fxcrm\fx\crm-new-laravel\resources\views/auth/admins/login.blade.php ENDPATH**/ ?>