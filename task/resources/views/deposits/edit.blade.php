    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6">
            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-semibold text-gray-900">Edit Deposit</h1>
        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <form action="{{ route('deposits.update', $deposit) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="date" id="date" value="{{ old('date', $deposit->date->format('Y-m-d')) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="customer_name" id="customer_name" value="{{ old('customer_name', $deposit->customer_name) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="tel" name="customer_phone" id="customer_phone" value="{{ old('customer_phone', $deposit->customer_phone) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="customer_email" id="customer_email" value="{{ old('customer_email', $deposit->customer_email) }}"
                ...
                <div class="mb-4">
                    ...
                    <select name="manager_id" id="manager_id"
                        ...
                        @foreach($managers as $manager)
                            <option value="{{ $manager->id }}" {{ old('manager_id', $deposit->manager_id) == $manager->id ? 'selected' : '' }}>
                                {{ $manager->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <select name="country_id" id="country_id"
                        ...
                        @foreach($countries as $country)
                            <option value="{{ $country->id }}" {{ old('country_id', $deposit->country_id) == $country->id ? 'selected' : '' }}>
                                {{ $country->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" name="usdt_rate" id="usdt_rate" value="{{ old('usdt_rate', $deposit->usdt_rate) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" name="amount_in_usdt" id="amount_in_usdt" value="{{ old('amount_in_usdt', $deposit->amount_in_usdt) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="account_number" id="account_number" value="{{ old('account_number', $deposit->account_number) }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('description') border-red-500 @enderror">{{ old('description', $deposit->description) }}</textarea>
                </div>
