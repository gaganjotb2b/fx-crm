...
@section('title', 'Create New Withdrawal')

@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6">
            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-semibold text-gray-900">Create Withdrawal</h1>
        ...
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <form action="{{ route('withdrawals.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="manager_id" id="manager_id" value="{{ old('manager_id') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" name="usdt_rate" id="usdt_rate" value="{{ old('usdt_rate') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="amount_in_usdt" id="amount_in_usdt" value="{{ old('amount_in_usdt', '0.00') }}"
